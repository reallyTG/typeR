...
### Name: AllPossibleSpellings-package
### Title: Finds all of word's possible spellings.
### Aliases: AllPossibleSpellings-package AllPossibleSpellings
### Keywords: AllPossibleSpellings
