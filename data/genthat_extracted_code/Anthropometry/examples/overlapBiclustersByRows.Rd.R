...
### Name: overlapBiclustersByRows
### Title: Overlapped biclusters by rows
### Aliases: overlapBiclustersByRows
### Keywords: manip
...
##D #For a single size:
##D size <- 5
##D res <- res_bicl_antropom[[1]][[size]]
##D 
##D sapply(1 : res@Number, overlapBiclustersByRows, res)
## End(Not run)
