...
### Name: pbart
### Title: Probit BART for dichotomous outcomes with Normal latents
### Aliases: pbart
...
## Not run: 
##D set.seed(21)
##D post <- pbart(train, y, test)
##D 
##D ## turn z-scores into probabilities
##D post$prob.test <- pnorm(post$yhat.test)
##D 
...
##D BART.itr.simp <- apply(pnorm(BART.itr.simp), 1, mean)
##D 
