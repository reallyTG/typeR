...
### Name: find.mle_FPK_multiple_clades_same_V_different_sig2
### Title: Maximum-likelihood estimation
### Aliases: find.mle_FPK_multiple_clades_same_V_different_sig2
...
##D #The trait evolves in the same macroevolutionary landscape but with different evolutionary rates.
