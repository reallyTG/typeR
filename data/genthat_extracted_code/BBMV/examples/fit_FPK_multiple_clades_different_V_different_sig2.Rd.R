...
### Name: fit_FPK_multiple_clades_different_V_different_sig2
### Title: Fit independent models in several clades.
### Aliases: fit_FPK_multiple_clades_different_V_different_sig2
...
##D fitmFPK4=fit_FPK_multiple_clades_different_V_different_sig2(trees=TREES,
