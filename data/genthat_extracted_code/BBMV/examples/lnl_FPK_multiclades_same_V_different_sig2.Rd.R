...
### Name: lnl_FPK_multiclades_same_V_different_sig2
### Title: Likelihood functions for multiple clades
### Aliases: lnl_FPK_multiclades_same_V_different_sig2
###   lnl_BBMV_multiclades_same_V_different_sig2
###   lnl_BBMV_multiclades_same_V_same_sig2
