...
### Name: compute_posterior_intervals
### Title: Compute Posterior Intervals
### Aliases: compute_posterior_intervals
...
## Not run: 
##D   # Posterior intervals of cluster probabilities
...
##D   # Keeping the burnin at 1000, we can compute the posterior intervals of the cluster probabilities
##D   compute_posterior_intervals(model_fit, burnin = 1000, parameter = "cluster_probs")
## End(Not run)
