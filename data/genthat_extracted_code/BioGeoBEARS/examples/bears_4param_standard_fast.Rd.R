...
### Name: bears_4param_standard_fast
### Title: 4-parameter model, adding j (founder-event speciation) and v
###   (vicariance proportion)
### Aliases: bears_4param_standard_fast
...
## Not run: 
##D # Run the ML search
##D bears_output = bears_4param_standard_fast(trfn=trfn, geogfn=geogfn)
##D bears_output
## End(Not run)
