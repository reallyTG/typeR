...
### Name: bears_5param_standard_fast
### Title: 5-parameter model, adding j (founder-event speciation), v
###   (vicariance proportion), and maxent_constraint_01 (weighting for size
###   of smaller-ranged descendant lineage)
### Aliases: bears_5param_standard_fast
...
## Not run: 
##D # Run the ML search
##D bears_output = bears_5param_standard_fast(trfn=trfn, geogfn=geogfn)
##D bears_output
## End(Not run)
