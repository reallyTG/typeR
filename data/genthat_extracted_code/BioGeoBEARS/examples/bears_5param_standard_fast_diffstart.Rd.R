...
### Name: bears_5param_standard_fast_diffstart
### Title: 5-parameter model, with different starting points for
###   optimization
### Aliases: bears_5param_standard_fast_diffstart
...
## Not run: 
##D # Run the ML search
##D bears_output = bears_5param_standard_fast_diffstart(trfn=trfn, geogfn=geogfn)
##D bears_output
## End(Not run)
