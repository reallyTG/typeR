...
### Name: post_prob_states_matrix
### Title: Calculate posterior probability of each states/geographic
###   ranges, given prior probabilities and data likelihoods
### Aliases: post_prob_states_matrix
