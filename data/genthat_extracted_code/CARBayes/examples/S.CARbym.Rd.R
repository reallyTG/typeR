...
###   random effects have a BYM conditional autoregressive prior.
### Aliases: S.CARbym
...
formula <- Y ~ x1 + x2
## Not run: 
##D model <- S.CARbym(formula=formula, family="binomial", trials=trials,
##D W=W, burnin=20000, n.sample=100000)
## End(Not run)
