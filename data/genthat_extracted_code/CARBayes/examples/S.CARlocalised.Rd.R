...
### Name: S.CARlocalised
### Title: Fit a spatial generalised linear mixed model to data, where a
###   set of spatially smooth random effects are augmented with a piecewise
###   constant intercept process.
### Aliases: S.CARlocalised
...
formula <- Y ~ 1
## Not run: 
##D model <- S.CARlocalised(formula=formula, family="binomial", trials=trials,
##D G=2, W=W,burnin=20000, n.sample=100000)
## End(Not run)
