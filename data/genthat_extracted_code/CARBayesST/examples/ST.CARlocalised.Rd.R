...
### Name: ST.CARlocalised
### Title: Fit a spatio-temporal generalised linear mixed model to data,
###   with a spatio-temporal autoregressive process and a piecewise
###   constant intercept term.
### Aliases: ST.CARlocalised
...
#### Run the model     
## Not run: 
##D model <- ST.CARlocalised(formula=Y~1, family="poisson", G=3, W=W, burnin=10000,
##D n.sample=50000)
## End(Not run)
