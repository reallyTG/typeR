...
### Name: CBDA.training
### Title: Training/Learning Compressive Big Data Analytics - CBDA.training
###   function
### Aliases: CBDA.training
...
##D 
##D # Call the CBDA function
##D # Multicore functionality NOT enabled
##D CBDA_object <- CBDA.training(Ytemp , Xtemp , M = 12 , Nrow_min = 50, Nrow_max = 70,
...
##D CBDA_test <- CBDA.training(Ytemp , Xtemp , M = 40 , Nrow_min = 50, Nrow_max = 70,
