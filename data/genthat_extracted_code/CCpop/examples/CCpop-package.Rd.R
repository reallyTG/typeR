...
### Name: CCpop-package
### Title: One and two locus GWAS of binary phenotype with
###   case-control-population design
### Aliases: CCpop-package CCpop
### Keywords: GWAS case-control case-population case-control-population
