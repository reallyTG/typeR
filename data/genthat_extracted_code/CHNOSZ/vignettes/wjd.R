...
###################################################
### code chunk number 15: w3_ep_plot
###################################################
par(mar = c(4.2, 4.2, 1.1, 1.1))
par(mgp = c(2, 1, 0))
w3 <- wjd(imax=3)
...
###################################################
### code chunk number 17: w_ep_plot
###################################################
par(mar = c(4.2, 4.2, 1.1, 1.1))
par(mgp = c(2, 1, 0))
...
###################################################
### code chunk number 18: w_ep_plot
###################################################
...
###################################################
### code chunk number 21: stoich_guess
###################################################
wY1 <- wjd(Y=Y1)
...
###################################################
### code chunk number 23: compare_guesses
###################################################
...
###################################################
### code chunk number 24: allguesses
###################################################
...
###################################################
### code chunk number 25: allguess.equil
###################################################
sapply(iYs,function(i) is.near.equil(wjd(Y=Ys[[i]])))


###################################################
### code chunk number 26: allguess.equil.2
###################################################
sapply(iYs,function(i) is.near.equil(wjd(Y=Ys[[i]]),tol=0.0001))


###################################################
### code chunk number 27: allguess.equil.3
###################################################
...
###################################################
### code chunk number 28: sd.species
###################################################
...
###################################################
### code chunk number 29: read_dlen
###################################################
...
###################################################
### code chunk number 30: setup_atmos
###################################################
...
###################################################
### code chunk number 31: atmos_C15
###################################################
sort(min.atmos(15)$X, decreasing=TRUE)


###################################################
### code chunk number 32: atmos_figure
###################################################
# xCs <- seq(8, 47, 1)
...
###################################################
### code chunk number 33: alkanes_aromatics
###################################################
...
###################################################
### code chunk number 35: run_aa_equil
###################################################
...
###################################################
### code chunk number 36: barplot_aa
###################################################
...
###################################################
### code chunk number 37: element_potentials_C84H106
###################################################
...
###################################################
### code chunk number 39: run_aa_C100H70
###################################################
...
###################################################
### code chunk number 40: basis_potentials_C84H106
###################################################
