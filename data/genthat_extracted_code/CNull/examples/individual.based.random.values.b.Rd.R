...
### Name: individual.based.random.values.b
### Title: Produces a set of random values for a beta diversity measure f
###   on a given matrix, based on the individual-based null model (Stegen
###   et al. 2013)
### Aliases: individual.based.random.values.b
