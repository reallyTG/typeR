...
### Name: permutation.pvalues.a
### Title: Produces the p-values of an alpha diversity measure f on a given
###   matrix, based on the permutation (SIM2) null model
### Aliases: permutation.pvalues.a
