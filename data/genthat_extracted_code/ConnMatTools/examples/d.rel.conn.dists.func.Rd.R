...
### Name: d.rel.conn.dists.func
### Title: Functions for estimating the probability distribution for
###   relative connectivity given a pair of distributions for scores for
###   marked and unmarked individuals
### Aliases: d.rel.conn.dists.func p.rel.conn.dists.func
