...
### Name: plot.WS.Corr.Mixed
### Title: Plot the within-subject correlations (reliabilities) obtained by
###   using the mixed-effects modeling approch
### Aliases: plot.WS.Corr.Mixed plot.WS.Corr.Mixed.SAS 'plot WS.Corr.Mixed'
###   'plot WS.Corr.Mixed.SAS'
