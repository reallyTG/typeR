...
##D data_subset <- exclude_data_subset(counts=myCounts, targets=myTargets,
##D                                   target_count_id_map="sample_id",
##D                                   target_exclude_col="timepoint",
##D                                   target_exclude_val="day1")
##D 
...
##D                                   target_count_id_map="sample_id",
##D                                   target_exclude_col="timepoint",
##D                                   target_exclude_val=c("day1","day2"))
##D 
##D #Count data is stored in the first index returned by the function.
##D subset_counts <- data_subset[[1]]
##D 
