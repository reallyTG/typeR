...
### Aliases: DPMrasch DPMrasch.default
...
##D       theta <- ind*rnorm(nsubject,-1,sqrt(0.25))+
##D                (1-ind)*rnorm(nsubject,2,sqrt(0.065))
##D       beta <- c(0,seq(-3,3,length=nitem-1))
##D 
##D       true.density <- function(grid)
##D       {
##D             0.5*dnorm(grid,-1,sqrt(0.25))+0.5*dnorm(grid,2,sqrt(0.065))  
##D       } 
##D 
##D       true.cdf <- function(grid)
##D       {
##D             0.5*pnorm(grid,-1,sqrt(0.25))+0.5*pnorm(grid,2,sqrt(0.065))  
##D       } 
##D 
