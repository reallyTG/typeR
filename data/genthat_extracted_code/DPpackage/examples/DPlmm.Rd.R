...
##D     # Prior information
##D 
##D       prior<-list(alpha=1,nu0=4.01,tau1=0.01,tau2=0.01,
##D                   tinv=diag(10,2),mub=rep(0,2),Sb=diag(1000,2))
##D 
##D     # Initial state
##D       state <- NULL
##D 
...
##D       state<-fit1$state     
##D     
##D       fit2<-DPlmm(fixed=height~1,random=~age|child,prior=prior,mcmc=mcmc,
