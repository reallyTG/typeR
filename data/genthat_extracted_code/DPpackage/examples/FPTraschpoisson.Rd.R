...
### Name: FPTraschpoisson
### Title: Bayesian analysis for a Finite Polya Tree Rasch Poisson model
### Aliases: FPTraschpoisson FPTraschpoisson.default
...
##D       beta <- c(0,seq(-1,1,length=nitem-1))
...
##D 
##D     # Fit the model
##D       fit1 <- FPTraschpoisson(y=y,prior=prior,mcmc=mcmc,
