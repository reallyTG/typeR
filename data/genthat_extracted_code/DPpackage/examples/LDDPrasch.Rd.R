...
### Name: LDDPrasch
### Title: Bayesian analysis for a dependent semiparametric Rasch model
### Aliases: LDDPrasch LDDPrasch.default
...
##D 
##D       beta <- c(0,seq(-4,4,length=nitem-1))
##D 
...
##D    ###########################
##D  
##D      fitLDDP <-  LDDPrasch(formula=y ~ trt,
##D                            prior=prior,
##D                            mcmc=mcmc,
##D                            state=NULL,
##D                            status=TRUE,
