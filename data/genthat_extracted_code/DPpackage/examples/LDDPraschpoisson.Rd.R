...
### Name: LDDPraschpoisson
### Title: Bayesian analysis for a dependent semiparametric Rasch Poisson
###   model
### Aliases: LDDPraschpoisson LDDPraschpoisson.default
...
##D 
##D       beta <- c(0,seq(-3,-1,length=nitem-1))
##D 
...
##D    ###########################
##D  
##D      fitLDDP <-  LDDPraschpoisson(formula=y ~ trt,
##D                                   prior=prior,
##D                                   mcmc=mcmc,
##D                                   state=NULL,
##D                                   status=TRUE,
...
##D      DPcaterpillar(DPrandom(fitLDPP))
##D 
## End(Not run)
