...
### Name: predict.DPsurvint
### Title: Computes the Survival Curve in a Bayesian analysis for a
###   semiparametric AFT regression model
### Aliases: predict.DPsurvint
### Keywords: models
...
##D 
##D     # Prior information
##D       prior <- list(alpha=10,beta0=rep(0,2),Sbeta0=diag(100000,2),
...
##D 
##D 
##D     # Predictive information for baseline survival
##D       grid<-seq(0.00001,14,0.5)
##D       pred<-predict(fit1,grid=grid)
##D       
##D     # Plot Baseline information with and without Credibility band
##D       plot(pred)
##D       plot(pred,band=TRUE)
##D   
...
##D       grid<-seq(0.00001,14,0.5)
##D       pred<-predict(fit1,xnew=xnew,grid=grid)
##D 
