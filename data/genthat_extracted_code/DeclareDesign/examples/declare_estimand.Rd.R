...
### Title: Declare estimand
### Aliases: declare_estimand declare_estimands estimand_handler
...
## Not run: 
##D diagnose_design(design, sims = 20, bootstrap_sims = FALSE,
##D                 diagnosands = declare_diagnosands(
##D                 select = c(mean_estimate, mean_estimand)))
## End(Not run)
