...
### Name: compute_Ji
### Title: Function to compute the evolution of the Ji metric for a term
###   (e.g. publication title) present in the reference list of a
###   bibliographic dataset.
### Aliases: compute_Ji 'Ji Metric'
### Keywords: ~kwd1 ~kwd2
