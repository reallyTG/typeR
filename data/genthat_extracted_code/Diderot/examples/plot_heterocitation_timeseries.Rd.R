...
### Name: plot_heterocitation_timeseries
### Title: Function to plot the heterocitation share and heterocitation
###   balance timeseries
### Aliases: plot_heterocitation_timeseries 'Heterocitation Timeseries'
