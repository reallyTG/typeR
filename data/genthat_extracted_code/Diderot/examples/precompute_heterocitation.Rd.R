...
### Name: precompute_heterocitation
### Title: This function precomputes heterocitation values for each
###   node/publication of a graph.
### Aliases: precompute_heterocitation
### Keywords: ~kwd1 ~kwd2
