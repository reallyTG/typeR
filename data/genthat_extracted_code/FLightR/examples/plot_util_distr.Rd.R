...
### Name: plot_util_distr
### Title: plots resulting track over map with uncertainty shown by space
###   utilisation distribution
### Aliases: plot_util_distr
...
## Not run: 
##D plot_util_distr(Result, zoom=6, save=FALSE)
## End(Not run)
