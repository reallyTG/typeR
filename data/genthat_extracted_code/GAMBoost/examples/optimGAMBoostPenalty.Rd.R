...
### Name: optimGAMBoostPenalty
### Title: Coarse line search for adequate GAMBoost penalty parameter
### Aliases: optimGAMBoostPenalty
...
##D ##  in the range [50,200] and return a GAMBoost fit with
##D ##  this penalty
##D 
##D opt.gb1 <- optimGAMBoostPenalty(x,y,minstepno=50,maxstepno=200,
