...
### Name: GLSME
### Title: Estimate regression parameters with correlated observations
###   measurement errors.
### Aliases: GLSME
### Keywords: generalized least squares regression measurement error
...
##D GLSME(y=y, CenterPredictor=TRUE, D=cbind(rep(1, n), x), Vt=vcv(apetree), 
##D Ve=yerror, Vd=list("F",vcv(apetree)), Vu=list("F", xerror))
## End(Not run)
