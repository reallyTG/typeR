...
###   ratios for prediction of excessive GWG for obese women
### Aliases: OB_above
### Keywords: datasets
...
#Plot of positive likelihood ratios for excessive GWG for obese women 
plot(OB_above$month, OB_above$lr.pos.est,
     xlim=c(1,10),
     ylim=c(0,20),
     ...
     cex.lab=1.9,
     cex.axis=1.5)
lines(OB_above$month, OB_above$lr.pos.est, lty=1,lwd=4)
lines(OB_above$month, OB_above$lr.pos.lower, lty=2,lwd=4)
lines(OB_above$month, OB_above$lr.pos.upper, lty=2,lwd=4)
