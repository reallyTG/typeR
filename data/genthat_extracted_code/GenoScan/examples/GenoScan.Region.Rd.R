...
### Name: GenoScan.Region
### Title: Scan the association between an quantitative/dichotomous outcome
###   variable and a region by score type statistics allowing for multiple
###   functional annotation scores.
### Aliases: GenoScan.Region
### Keywords: region scan
