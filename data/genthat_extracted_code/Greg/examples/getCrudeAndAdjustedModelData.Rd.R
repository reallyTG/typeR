...
### Name: getCrudeAndAdjustedModelData
### Title: This function helps with printing regression models
### Aliases: getCrudeAndAdjustedModelData [.getCrudeAndAdjustedModelData
### Keywords: internal
