...
### Name: printCrudeAndAdjustedModel
### Title: Output crude and adjusted model data
### Aliases: printCrudeAndAdjustedModel rbind.printCrudeAndAdjusted
###   print.printCrudeAndAdjusted htmlTable.printCrudeAndAdjusted
###   [.printCrudeAndAdjusted cbind.printCrudeAndAdjusted
###   knit_print.printCrudeAndAdjusted latex.printCrudeAndAdjusted
### Keywords: internal
