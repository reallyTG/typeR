...
### Name: Gen.Alg.Consensus
### Title: Find Taxa Separating Two Groups using Multiple Genetic
###   Algorithm's (GA) Consensus
### Aliases: Gen.Alg.Consensus
...
##D 		numRuns <- 3
##D 		
##D 		gaRes <- Gen.Alg.Consensus(dataNorm, covars, .5, numRuns, FALSE, 3, 
