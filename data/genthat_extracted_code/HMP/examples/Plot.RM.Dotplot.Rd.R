...
##D 		
##D 		### Plot the data with error bars
##D 		Plot.RM.Dotplot(group.data, groups, times)
##D 		
##D 		### Plot the data without error bars
##D 		Plot.RM.Dotplot(group.data, groups, times, FALSE)
##D 	
## End(Not run)
