...
### Name: plot.mcmcComposite
### Title: Plot the result of a mcmcComposite object
### Aliases: plot.mcmcComposite
...
##D mcmc_run <- MHalgoGen(n.iter=50000, parameters=parameters_mcmc, data=x, 
##D adaptive = TRUE,
...
##D mcmc_run2 <- MHalgoGen(n.iter=50000, parameters=parameters_mcmc, data=x, 
##D adaptive = TRUE,
