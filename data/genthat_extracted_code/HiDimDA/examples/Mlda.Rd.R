...
### Name: Mlda
### Title: Maximum uncertainty Linear Discriminant Analysis.
### Aliases: Mlda Mlda.default Mlda.data.frame is.Mlda
...
## Not run: 
##D 
##D CrosValRes <- DACrossVal(log10genes,AlonDS$grouping,TrainAlg=Mlda,
