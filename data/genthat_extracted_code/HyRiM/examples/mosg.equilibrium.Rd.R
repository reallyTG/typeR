...
### Name: mosg.equilibrium
### Title: embodies all information related to an equilibrium computed by
###   the function 'mgss'.
### Aliases: summary.mosg.equilibrium print.mosg.equilibrium
###   plot.mosg.equilibrium print.mosg.equilibrium.summary
