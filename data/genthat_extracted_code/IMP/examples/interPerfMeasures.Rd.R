...
##D interPerfMeasures(list_models = list(df1,df2))
## End(Not run)
...
glm_model <- function(formula) {
 ...
 ## Not run: 
##D  #This will launch a Shiny App
##D  interPerfMeasures (model_function = glm_model,data=iris,y="Species")
## End(Not run)
