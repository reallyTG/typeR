...
### Name: fitIPEC
### Title: Nonlinear Fitting Function
### Aliases: fitIPEC
...
##D ylab1 <- expression( paste("Developmental rate"^{1/2}, 
##D                      " (", d^{"-1"}, ")", sep="") )
##D resu0 <- fitIPEC( myfun, x=x2, y=y2, ini.val=ini.val1, xlim=NULL, 
##D                   ylim=NULL, xlab=xlab1, ylab=ylab1, fig.opt=TRUE, 
