...
##D 
##D # Use getDataselect to request data for II.JTS.00.BHZ
##D starttime <- as.POSIXct("2001-02-28",tz="GMT")
##D endtime <- as.POSIXct("2001-03-01",tz="GMT")
##D 
##D st <- getDataselect(iris, "II","JTS","00","BHZ",starttime, endtime, 
##D                     inclusiveEnd=FALSE,ignoreEpoch=TRUE)
##D 
