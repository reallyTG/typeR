...
### Name: getStation
### Title: Retrieve Station metadata from IRIS DMC
### Aliases: getStation
###   getStation,IrisClient,character,character,character,character,POSIXct,POSIXct,logical-method
###   getStation,IrisClient,character,character,character,character,POSIXct,POSIXct,missing-method
