...
### Name: bandwidth.choose
### Title: Selection of optiaml bandwidth for nonparametric density
###   estimation of currenst status failure times.
### Aliases: bandwidth.choose
### Keywords: bandwidth
