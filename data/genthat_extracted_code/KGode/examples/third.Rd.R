...
##D crtype='i'
##D ## using cross validation to estimate the weighting parameters of the ode regularisation 
##D lam=c(1e-4,1e-5)
##D lamil1 = crossv(lam,kkk,bbb,crtype,y_no)
##D lambdai1=lamil1[[1]]
##D 
##D ## estimate ode parameters using gradient matching and ode regularisation
##D res = third(lambdai1,kkk,bbb,crtype)
##D ## display the ode parameter estimation.
##D res$oppar
## End(Not run)
