...
### Name: Predict_kernel_Ridge_MM
### Title: Predict function for Kernel_Ridge_MM object
### Aliases: Predict_kernel_Ridge_MM
...
##D 
##D ### Predict new entries for target set and measure prediction error
##D 
