...
### Name: max_vorob_parallel
### Title: Minimizer of the parallel vorob criterion
### Aliases: max_vorob_parallel
...
## Not run: 
##D obj <- max_vorob_parallel(lower=lower,upper=upper,optimcontrol=optimcontrol,
...
##D 
##D par(mfrow=c(1,2))
##D print_uncertainty(model=model,T=T,type="pn",lower=lower,upper=upper,vorobmean=TRUE,
##D cex.points=2.5,main="probability of excursion")
##D 
##D print_uncertainty(model=new.model,T=T,type="pn",lower=lower,upper=upper,vorobmean=TRUE,
