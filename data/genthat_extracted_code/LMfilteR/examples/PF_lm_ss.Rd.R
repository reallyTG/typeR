...
##D Res <- PF_lm_ss(n=10000L, sigma_est = FALSE) #10 times more than in PF_lm
...
##D sumRes
##D par(mfrow=c(2, 2)) #Evolution of the mean of PF estimation on each time
##D for (i in 2:5){
...
##D Res2 <- PF_lm_ss(n = 1000L, sigma_est = TRUE)
...
##D sumRes2
##D 
##D par(mfrow=c(2, 3)) #Evolution of the mean of PF estimation
##D for (i in 2:6){
...
##D                 -1, 0)  # Prior of a_3
##D                 ,ncol = 2, byrow = TRUE )
##D Res3 <- PF_lm_ss(n=10000L, sigma_est = FALSE, initDisPar = b0)
...
##D sumRes3
##D 
##D par(mfrow=c(2, 2)) #Evolution of the mean of PF estimation
##D for (i in 2:5){
