...
### Name: theta-utils
### Title: Utilities for the parameter vector of Lambert W\times F
###   distributions
### Aliases: check_theta complete_theta flatten_theta get_initial_theta
###   get_theta_bounds theta-utils theta2tau theta2unbounded
###   unflatten_theta
...
## Not run: 
##D check_theta(theta = list(beta =  c(1, 1, -1)), distname = "t")
## End(Not run)
