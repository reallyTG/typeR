...
### Aliases: LaplacesDemon LaplacesDemon.hpc
### Keywords: Adaptive Adaptive Directional Metropolis-within-Gibbs
###   Adaptive Griddy-Gibbs Adaptive Hamiltonian Monte Carlo Adaptive
###   Metropolis Adaptive-Mixture Metropolis Adaptive
###   Metropolis-within-Gibbs Affine-Invariant Ensemble Sampler Bayesian
###   Inference Delayed Rejection Adaptive Metropolis Delayed Rejection
###   Metropolis Differential Evolution Markov Chain Elliptical Slice
###   Sampler Gibbs Sampler Griddy-Gibbs Hamiltonian Monte Carlo High
###   Performance Computing Hit-And-Run Independence Metropolis Interchain
###   Adaptation MCMC Metropolis-Adjusted Langevin Algorithm
###   Metropolis-Coupled Markov Chain Monte Carlo Metropolis-within-Gibbs
###   Multiple-Try Metropolis Multiple Chains No-U-Turn Sampler Oblique
###   Hyperrectangle Slice Sampler Optimization Parallel Chains
###   Preconditioned Crank-Nicolson Reflective Slice Sampler Refractive
###   Sampler Reversible-Jump Robust Adaptive Metropolis Random-Walk
###   Metropolis Sequential Adaptive Metropolis-within-Gibbs Sequential
###   Metropolis-within-Gibbs Slice Sampler Stochastic Gradient Langevin
###   Dynamics Tempered Hamiltonian Monte Carlo t-walk Univariate
###   Eigenvector Slice Sampler Updating Sequential Adaptive
###   Metropolis-within-Gibbs Updating Sequential Metropolis-within-Gibbs
