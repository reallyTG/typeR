...
### Name: compute_LogDistance
### Title: Compute Logarithm Distance
### Aliases: compute_LogDistance
...
##D 
##D LogDistance <- compute_LogDistance(Sequences, label = "NonCoding", referFreq = referFreq,
