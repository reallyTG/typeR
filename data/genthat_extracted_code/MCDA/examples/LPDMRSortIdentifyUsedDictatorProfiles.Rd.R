...
### Name: LPDMRSortIdentifyUsedDictatorProfiles
### Title: Identify dictator profiles evaluations that have an impact on
###   the final assignments of MRSort with large performance differences
### Aliases: LPDMRSortIdentifyUsedDictatorProfiles
### Keywords: methods
