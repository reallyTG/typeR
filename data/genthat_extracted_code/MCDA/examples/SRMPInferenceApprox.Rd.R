...
### Name: SRMPInferenceApprox
### Title: Approximative inference of an SRMP model
### Aliases: SRMPInferenceApprox
### Keywords: methods
...
##D 
##D expectedpreorder <- list("a16","a13",c("a3","a9"),"a14","a17",c("a1","a7"),"a18","a15")
##D 
...
##D set.seed(1)
##D 
##D result<-SRMPInferenceApprox(performanceTable, criteriaMinMax, 3, preferencePairs,
##D                             indifferencePairs, alternativesIDs = c("a1","a3","a7",
##D                             "a9","a13","a14","a15","a16","a17","a18"))
## End(Not run)
