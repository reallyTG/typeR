...
### Name: SRMPInferenceNoInconsist
### Title: Exact inference of an SRMP model given a maximum number of
###   reference profiles - no inconsistencies
### Aliases: SRMPInferenceNoInconsist
### Keywords: methods
...
##D                               "a23","a23"),12,2)
##D 
##D result<-SRMPInferenceNoInconsist(performanceTable, criteriaMinMax, 3, preferencePairs,
##D                                  indifferencePairs, alternativesIDs = c("a1","a2","a3","a4",
##D                                  "a5","a6","a7","a8","a10","a11","a12","a14","a16","a17","a18",
##D                                  "a19","a20","a21","a23","a24"))
## End(Not run)
