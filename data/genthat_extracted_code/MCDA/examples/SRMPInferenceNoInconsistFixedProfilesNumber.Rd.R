...
### Name: SRMPInferenceNoInconsistFixedProfilesNumber
### Title: Exact inference of an SRMP model given the number of reference
###   profiles - no inconsistencies
### Aliases: SRMPInferenceNoInconsistFixedProfilesNumber
### Keywords: methods
...
##D                               "a23","a23"),12,2)
##D 
##D result<-SRMPInferenceNoInconsistFixedProfilesNumber(performanceTable, criteriaMinMax, 3,
##D                                                     preferencePairs, indifferencePairs,
##D                                                     alternativesIDs = c("a1","a2","a3","a4",
##D                                                     "a5","a6","a7","a8","a10","a11","a12",
##D                                                     "a14","a16","a17","a18","a19","a20","a21",
##D                                                     "a23","a24"))
## End(Not run)
