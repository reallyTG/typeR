...
### Name: assignAlternativesToCategoriesByThresholds
### Title: Assign alternatives to categories according to thresholds.
### Aliases: assignAlternativesToCategoriesByThresholds
### Keywords: methods
