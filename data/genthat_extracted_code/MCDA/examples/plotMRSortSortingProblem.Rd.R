...
### Name: plotMRSortSortingProblem
### Title: Plot the categories and assignments of an Electre TRI-like
###   sorting problem (via separation profiles).
### Aliases: plotMRSortSortingProblem
### Keywords: methods
