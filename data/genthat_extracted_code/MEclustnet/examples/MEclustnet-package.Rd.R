...
## Not run: 
##D fit = MEclustnet(lawyers.adjacency.friends, lawyers.covariates,
##D link.vars, mix.vars, G=2, d=2, itermax = 500, burnin = 50, uphill = 1, thin=10)
##D 
...
##D summ = summaryMEclustnet(fit, lawyers.adjacency.friends)
...
##D plotMEclustnet(fit, lawyers.adjacency.friends, link.vars, mix.vars)
## End(Not run)
