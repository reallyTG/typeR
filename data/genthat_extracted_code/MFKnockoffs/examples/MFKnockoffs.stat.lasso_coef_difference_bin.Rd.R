...
### Name: MFKnockoffs.stat.lasso_coef_difference_bin
### Title: Cross-validated penalized logistic regression statistics for
###   MFKnockoffs
### Aliases: MFKnockoffs.stat.lasso_coef_difference_bin
