...
### Name: lassop
### Title: L1-penalization in linear mixed models
### Aliases: lassop
...
##D p <- 80            # number of covariates (including intercept)
...
##D ########
##D 
##D #independent random effects
##D fit=lassop(x,y,z,grp,D=1,mu=0.2,fix=1,rand=c(1,2))
##D 
##D #dependent random effects
##D fit=lassop(x,y,z,grp,mu=0.2,fix=1,rand=c(1,2))
## End(Not run)
