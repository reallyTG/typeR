...
### Name: mhtp
### Title: Multiple testing procedure for variable selection in linear
###   mixed models
### Aliases: mhtp
...
##D 
##D ########
##D fit=mhtp(x,y,z,grp,D=0,fix=1,rand=c(1,2),alpha=0.1,num=15)
##D #fit=mhtp(x,y,z,grp,D=0,fix=1,rand=c(1,2),alpha=0.1,num=15,show=c(1,1,1))
## End(Not run)
