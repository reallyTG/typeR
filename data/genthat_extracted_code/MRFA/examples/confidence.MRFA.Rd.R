...
### Name: confidence.MRFA
### Title: Confidence Interval for Multiresolution Functional ANOVA (MRFA)
###   Model
### Aliases: confidence.MRFA
...
##D conf.interval <- confidence.MRFA(MRFA_model, X.test, X.train, lambda = min(MRFA_model$lambda))
##D print(conf.interval)
## End(Not run)
