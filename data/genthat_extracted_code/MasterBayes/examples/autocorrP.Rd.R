...
### Name: autocorrP
### Title: Autocorrelation Function for Parenatge Assignment
### Aliases: autocorrP
...
##D 
##D # individuals from the offspring generation are excluded as parents
##D 
...
##D 
##D model1<-MCMCped(PdP=PdP, GdP=GdP, tP=tP, nitt=3000, thin=1,  burnin=0, write_postP="JOINT") 
##D autocorrP(model1$P)
## End(Not run)
