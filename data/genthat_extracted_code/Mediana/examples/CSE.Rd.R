...
##D summary(case.study1.results)
##D 
##D # Get the data generated for the simulation
...
## Not run: 
##D #Alternatively, a DataStack object can be used in the CSE function
##D # (not recommanded as the computational time is increased)
##D 
##D # Generate data
##D case.study1.data.stack = DataStack(data.model = case.study1.data.model,
##D                                    sim.parameters = case.study1.sim.parameters)
##D 
##D # Perform clinical scenario evaluation with data stack
