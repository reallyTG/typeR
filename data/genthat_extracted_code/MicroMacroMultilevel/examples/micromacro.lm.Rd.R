...
### Name: micromacro.lm
### Title: Fitting Micro-Macro Multilevel Linear Models
### Aliases: micromacro.lm
### Keywords: different from group group-level individual-level
###   micro-macro, modeling, multi-level prediciting sizes variables
###   variables,
