...
### Name: Bias
### Title: Estimates bias for n number of multi-level random regression
###   models performed to n simulated data sets.
### Aliases: Bias
### Keywords: multi-level random regression bias
