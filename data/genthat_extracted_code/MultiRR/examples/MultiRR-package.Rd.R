...
### Name: MultiRR-package
### Title: Simulation Package for Multi-level random regressions
### Aliases: MultiRR-package MultiRR
### Keywords: package simulation multi-level random regression
