...
### Name: benchmark
### Title: Benchmark networks using Network Enrichment Analysis (NEA)
### Aliases: benchmark
### Keywords: ROC
...
## End(No test)
## Not run: 
##D ## Benchmark a number of networks on GO terms and KEGG pathways separately, using masks:
##D b1 <- NULL;
...
##D b1[[mask]][[file.net]] <- benchmark (NET = net, GS = gs.list, echo=1, 
##D graph=FALSE, na.replace = 0, mask = mask, minN = 0,  Parallelize=1);
##D }}
##D par(mfrow=c(2,1));
