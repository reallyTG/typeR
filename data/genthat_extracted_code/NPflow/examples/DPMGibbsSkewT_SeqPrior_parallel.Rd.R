...
### Name: DPMGibbsSkewT_SeqPrior_parallel
### Title: Slice Sampling of Dirichlet Process Mixture of skew Students's
###   t-distibutions
### Aliases: DPMGibbsSkewT_SeqPrior_parallel
...
##D }
##D MCMCsample_st2 <- DPMGibbsSkewT_SeqPrior_parallel(Ncpus=2, type_connec="SOCK",
##D                                                   z, prior_inform=s$param_posterior,
##D                                                   hyperG0, N=3000,
##D                                                   doPlot=TRUE, plotevery=100,
##D                                                   nbclust_init, diagVar=FALSE, verbose=FALSE,
##D                                                   gg.add=list(theme_bw(),
##D                                  guides(shape=guide_legend(override.aes = list(fill="grey45")))))
##D s2 <- summary(MCMCsample_st2, burnin = 2000, thin=5)
