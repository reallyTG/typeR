...
### Name: mxFitFunctionML
### Title: Create MxFitFunctionML Object
### Aliases: mxFitFunctionML MxFitFunctionML-class
###   print,MxFitFunctionML-method show,MxFitFunctionML-method
