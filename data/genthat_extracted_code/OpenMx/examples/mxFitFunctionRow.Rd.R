...
### Name: mxFitFunctionRow
### Title: Create an MxFitFunctionRow Object
### Aliases: mxFitFunctionRow MxFitFunctionRow-class
###   print,MxFitFunctionRow-method show,MxFitFunctionRow-method
