...
### Name: mxFitFunctionWLS
### Title: Create MxFitFunctionWLS Object
### Aliases: mxFitFunctionWLS MxFitFunctionWLS-class
###   print,MxFitFunctionWLS-method show,MxFitFunctionWLS-method
