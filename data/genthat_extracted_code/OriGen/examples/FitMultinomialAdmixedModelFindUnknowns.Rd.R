...
### Name: FitMultinomialAdmixedModelFindUnknowns
### Title: Fit the multinomial OriGen model and place unknown individuals
###   who may be admixed
### Aliases: FitMultinomialAdmixedModelFindUnknowns
...
##D MaxAlleles=2
##D if(MaxAlleles==2){
##D 	NumberAllelesAtEachLocus=rep(2,NumberLoci)
##D }else{
...
##D 	UnknownData,MaxGridLength=8,RhoParameter=10,MaskWater=TRUE)
##D 		
