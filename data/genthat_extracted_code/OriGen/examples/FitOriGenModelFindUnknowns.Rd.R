...
### Name: FitOriGenModelFindUnknowns
### Title: Fit the OriGen model and place unknown individuals
### Aliases: FitOriGenModelFindUnknowns
...
##D trials4=FitOriGenModelFindUnknowns(TestData,TestCoordinates,
##D 	TestUnknowns,MaxGridLength=20,RhoParameter=10)
##D str(trials4)
##D 
