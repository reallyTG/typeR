...
### Name: plot.PAFit_result
### Title: Plotting the estimated attachment function and node fitness of a
###   'PAFit_result' object
### Aliases: plot.PAFit_result
...
##D     #plot A
##D     plot(result$estimate_result , net_stats , plot = "A")
