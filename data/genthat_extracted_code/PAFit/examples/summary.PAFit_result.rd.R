...
### Name: summary.PAFit_result
### Title: Output summary information on the estimation result stored in a
###   'PAFit_result' object
### Aliases: summary.PAFit_result
...
##D     summary(result$estimate_result)
##D   
## End(Not run)
