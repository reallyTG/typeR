...
### Name: MergeProbDup
### Title: Merge two objects of class 'ProbDup'.
### Aliases: MergeProbDup
...
##D                  
##D # Split the probable duplicate sets
##D GNdupSplit <- SplitProbDup(GNdup, splitat = c(10, 10, 10))
##D 
##D # Merge the split sets
##D GNdupMerged <- MergeProbDup(GNdupSplit[[1]], GNdupSplit[[3]])
##D 
## End(Not run)
