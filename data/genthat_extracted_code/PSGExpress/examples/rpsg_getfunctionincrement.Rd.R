...
### Name: rpsg_getfunctionincrement
### Title: PSG Functions increments calculation
### Aliases: rpsg_getfunctionincrement
...
val1<- rpsg_getfunctionincrement("cvar_risk(0.65,matrix_scenarios)",point_a)
