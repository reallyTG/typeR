...
### Name: monitorMap_performance
### Title: Create Map of Monitor Prediction Performance
### Aliases: monitorMap_performance
### Keywords: ws_monitor
...
##D                                        radius = 50)
##D monitorMap_performance(ca, Vallejo, cex=2)
##D title('Heidike Skill of monitors predicting another monitor.')
## End(Not run)
