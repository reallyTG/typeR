...
##D validation_specs(num_pois, num_bin, num_ord, num_norm, corr.mat, pbin, pord, lambda,
##D normean,norvar)
##D 
##D num_pois<-2
##D num_bin<-2
...
##D TV=N+t(N)
##D diag(TV)<-1
##D validation_specs(num_pois, num_bin, num_ord, num_norm, corr.mat=TV, pbin, pord,
...
##D TV1=TV
##D TV1[3,2]=TV[2,3]=5
##D validation_specs(num_pois, num_bin, num_ord, num_norm, corr.mat=TV1, pbin, pord,
##D lamvec, normean, norvar) 
## End(Not run)
