...
### Name: ff.PKPD.1.comp.oral.md.CL.imax
### Title: Structural model: one-compartment, oral absorption, multiple
###   bolus dose, parameterized using CL driving an inhibitory IMAX model
###   with a direct effect.
### Aliases: ff.PKPD.1.comp.oral.md.CL.imax
