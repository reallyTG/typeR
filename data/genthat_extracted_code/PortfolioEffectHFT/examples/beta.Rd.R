...
### Name: beta
### Title: Beta
### Aliases: beta beta,portfolio-method beta,position-method
### Keywords: PortfolioEffectHFT beta
...
##D result=compute(beta(portfolio),beta(positionGOOG),beta(positionAAPL)) 
##D plot(beta(portfolio),beta(positionGOOG),beta(positionAAPL),
##D legend=c('Portfolio','GOOG','AAPL'),title='Beta')
##D 
...
##D result=compute(beta(positionC),beta(positionGOOG),beta(positionAAPL)) 
##D plot(beta(positionC),beta(positionGOOG),beta(positionAAPL),
##D legend=c('C','GOOG','AAPL'),title='Beta')
## End(Not run)
