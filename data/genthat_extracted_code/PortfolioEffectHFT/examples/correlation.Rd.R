...
### Name: correlation
### Title: Correlation
### Aliases: correlation correlation,portfolio,missing-method
###   correlation,position,position-method
### Keywords: PortfolioEffectHFT correlation
...
##D result=compute(correlation(positionGOOG,positionAAPL))
##D plot(correlation(positionGOOG,positionAAPL),title='Correlation')
##D 
...
##D result=compute(correlation(positionC,positionAAPL))
##D plot(correlation(positionC,positionAAPL),title='Correlation')
## End(Not run)
