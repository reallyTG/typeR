...
### Name: kurtosis
### Title: Kurtosis
### Aliases: kurtosis kurtosis,portfolio-method kurtosis,position-method
### Keywords: PortfolioEffectHFT kurtosis
...
##D result=compute(kurtosis(portfolio),kurtosis(positionGOOG),kurtosis(positionAAPL)) 
##D plot(kurtosis(portfolio),kurtosis(positionGOOG),kurtosis(positionAAPL),
##D legend=c('Portfolio','GOOG','AAPL'),title='Kurtosis')
##D 
...
##D result=compute(kurtosis(positionC),kurtosis(positionGOOG),kurtosis(positionAAPL)) 
##D plot(kurtosis(positionC),kurtosis(positionGOOG),kurtosis(positionAAPL),
##D legend=c('C','GOOG','AAPL'),title='Kurtosis')
## End(Not run)
