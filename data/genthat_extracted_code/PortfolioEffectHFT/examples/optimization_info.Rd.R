...
### Title: Porfolio Optimization - Print Optimization Details
### Aliases: optimization_info
### Keywords: PortfolioEffectHFT optimization_info
...
##D optimization_info(optimalPortfolio)
## End(Not run)
