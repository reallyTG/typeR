...
### Name: price
### Title: Price
### Aliases: price price,position-method
### Keywords: PortfolioEffectHFT price
...
##D result=compute(price(positionGOOG),price(positionAAPL)) 
##D plot(price(positionGOOG),price(positionAAPL),legend=c('GOOG','AAPL'),title='Price')
##D 
...
##D result=compute(price(positionC),price(positionGOOG),price(positionAAPL)) 
##D plot(price(positionC),price(positionGOOG),price(positionAAPL),
##D legend=c('C','GOOG','AAPL'),title='Price')
## End(Not run)
