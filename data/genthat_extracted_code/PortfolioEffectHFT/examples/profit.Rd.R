...
### Name: profit
### Title: Profit
### Aliases: profit profit,portfolio-method profit,position-method
### Keywords: PortfolioEffectHFT profit
...
##D result=compute(profit(portfolio),profit(positionGOOG),profit(positionAAPL)) 
##D plot(profit(portfolio),profit(positionGOOG),profit(positionAAPL),
##D legend=c('Portfolio','GOOG','AAPL'),title='Profit')
##D 
...
##D result=compute(profit(positionC),profit(positionGOOG),profit(positionAAPL)) 
##D plot(profit(positionC),profit(positionGOOG),profit(positionAAPL),
##D legend=c('C','GOOG','AAPL'),title='Profit')
## End(Not run)
