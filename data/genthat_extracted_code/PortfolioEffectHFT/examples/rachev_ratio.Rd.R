...
### Name: rachev_ratio
### Title: Rachev Ratio
### Aliases: rachev_ratio rachev_ratio,portfolio-method
###   rachev_ratio,position-method
### Keywords: PortfolioEffectHFT rachev_ratio
...
##D result=compute(rachev_ratio(portfolio,0.95,0.95),rachev_ratio(positionGOOG,0.95,0.95),
##D rachev_ratio(positionAAPL,0.95,0.95)) 
##D plot(rachev_ratio(portfolio,0.95,0.95),rachev_ratio(positionGOOG,0.95,0.95),
##D rachev_ratio(positionAAPL,0.95,0.95),legend=c('Portfolio','GOOG','AAPL'),title='Rachev Ratio')
##D 
...
##D result=compute(rachev_ratio(positionC,0.95,0.95),rachev_ratio(positionGOOG,0.95,0.95),
##D rachev_ratio(positionAAPL,0.95,0.95)) 
##D plot(rachev_ratio(positionC,0.95,0.95),rachev_ratio(positionGOOG,0.95,0.95),
##D rachev_ratio(positionAAPL,0.95,0.95),legend=c('C','GOOG','AAPL'),title='Rachev Ratio')
## End(Not run)
