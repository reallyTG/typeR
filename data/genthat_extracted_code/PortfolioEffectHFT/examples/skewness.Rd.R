...
### Name: skewness
### Title: Skewness
### Aliases: skewness skewness,portfolio-method skewness,position-method
### Keywords: PortfolioEffectHFT skewness
...
##D result=compute(skewness(portfolio),skewness(positionGOOG),skewness(positionAAPL)) 
##D plot(skewness(portfolio),skewness(positionGOOG),skewness(positionAAPL),
##D legend=c('Portfolio','GOOG','AAPL'),title='Skewness')
##D 
...
##D result=compute(skewness(positionC),skewness(positionGOOG),skewness(positionAAPL)) 
##D plot(skewness(positionC),skewness(positionGOOG),skewness(positionAAPL),
##D legend=c('C','GOOG','AAPL'),title='Skewness')
## End(Not run)
