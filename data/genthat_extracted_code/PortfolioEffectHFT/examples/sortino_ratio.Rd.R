...
### Name: sortino_ratio
### Title: Sortina Ratio
### Aliases: sortino_ratio sortino_ratio,portfolio-method
###   sortino_ratio,position-method
### Keywords: PortfolioEffectHFT sortino_ratio
...
##D result=compute(sortino_ratio(portfolio,0.05),sortino_ratio(positionGOOG,0.05),
##D sortino_ratio(positionAAPL,0.05)) 
##D plot(sortino_ratio(portfolio,0.05),sortino_ratio(positionGOOG,0.05),
##D sortino_ratio(positionAAPL,0.05),legend=c('Portfolio','GOOG','AAPL'),title='Sortina Ratio')
##D 
...
##D result=compute(sortino_ratio(positionC,0.05),sortino_ratio(positionGOOG,0.05),
##D sortino_ratio(positionAAPL,0.05)) 
##D plot(sortino_ratio(positionC,0.05),sortino_ratio(positionGOOG,0.05),
##D sortino_ratio(positionAAPL,0.05),legend=c('C','GOOG','AAPL'),title='Sortina Ratio')
## End(Not run)
