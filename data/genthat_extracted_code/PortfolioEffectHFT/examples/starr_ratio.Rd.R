...
### Name: starr_ratio
### Title: STARR Ratio
### Aliases: starr_ratio starr_ratio,portfolio-method
###   starr_ratio,position-method
### Keywords: PortfolioEffectHFT starr_ratio
...
##D result=compute(starr_ratio(portfolio,0.95),starr_ratio(positionGOOG,0.95),
##D starr_ratio(positionAAPL,0.95)) 
##D plot(starr_ratio(portfolio,0.95),starr_ratio(positionGOOG,0.95),
##D starr_ratio(positionAAPL,0.95),legend=c('Portfolio','GOOG','AAPL'),title='STARR Ratio')
##D 
...
##D result=compute(starr_ratio(positionC,0.95),starr_ratio(positionGOOG,0.95),
##D starr_ratio(positionAAPL,0.95)) 
##D plot(starr_ratio(positionC,0.95),starr_ratio(positionGOOG,0.95),
##D starr_ratio(positionAAPL,0.95),legend=c('C','GOOG','AAPL'),title='STARR Ratio')
## End(Not run)
