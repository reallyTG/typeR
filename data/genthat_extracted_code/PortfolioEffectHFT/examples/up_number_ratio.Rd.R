...
### Title: Up Number Ratio
### Aliases: up_number_ratio up_number_ratio,portfolio-method
###   up_number_ratio,position-method
### Keywords: PortfolioEffectHFT up_number_ratio
...
##D result=compute(up_number_ratio(portfolio),up_number_ratio(positionGOOG),
##D up_number_ratio(positionAAPL)) 
##D plot(up_number_ratio(portfolio),up_number_ratio(positionGOOG),
##D up_number_ratio(positionAAPL),legend=c('Portfolio','GOOG','AAPL'),title='Up Number Ratio')
##D 
...
##D result=compute(up_number_ratio(positionC),up_number_ratio(positionGOOG),
##D up_number_ratio(positionAAPL)) 
##D plot(up_number_ratio(positionC),up_number_ratio(positionGOOG),
##D up_number_ratio(positionAAPL),legend=c('C','GOOG','AAPL'),title='Up Number Ratio')
## End(Not run)
