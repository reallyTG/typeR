...
### Title: Up Percentage Ratio
### Aliases: up_percentage_ratio up_percentage_ratio,portfolio-method
###   up_percentage_ratio,position-method
### Keywords: PortfolioEffectHFT up_percentage_ratio
...
##D result=compute(up_percentage_ratio(portfolio),up_percentage_ratio(positionGOOG),
##D up_percentage_ratio(positionAAPL)) 
##D plot(up_percentage_ratio(portfolio),up_percentage_ratio(positionGOOG),
##D up_percentage_ratio(positionAAPL),legend=c('Portfolio','GOOG','AAPL'),title='Up Percentage Ratio')
##D 
...
##D result=compute(up_percentage_ratio(positionC),up_percentage_ratio(positionGOOG),
##D up_percentage_ratio(positionAAPL)) 
##D plot(up_percentage_ratio(positionC),up_percentage_ratio(positionGOOG),
##D up_percentage_ratio(positionAAPL),legend=c('C','GOOG','AAPL'),title='Up Percentage Ratio')
## End(Not run)
