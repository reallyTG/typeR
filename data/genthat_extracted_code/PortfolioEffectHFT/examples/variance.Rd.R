...
### Name: variance
### Title: Variance
### Aliases: variance variance,portfolio-method variance,position-method
### Keywords: PortfolioEffectHFT variance
...
##D result=compute(variance(portfolio),variance(positionGOOG),variance(positionAAPL)) 
##D plot(variance(portfolio),variance(positionGOOG),variance(positionAAPL),
##D legend=c('Portfolio','GOOG','AAPL'),title='Variance')
##D 
...
##D result=compute(variance(positionC),variance(positionGOOG),variance(positionAAPL)) 
##D plot(variance(positionC),variance(positionGOOG),variance(positionAAPL),
##D legend=c('C','GOOG','AAPL'),title='Variance')
## End(Not run)
