...
### Name: weight
### Title: Weight
### Aliases: weight weight,portfolio-method weight,position-method
### Keywords: PortfolioEffectHFT weight
...
##D result=compute(weight(positionGOOG),weight(positionAAPL)) 
##D plot(weight(positionGOOG),weight(positionAAPL),legend=c('GOOG','AAPL'),title='Weight')
##D 
...
##D result=compute(weight(positionC),weight(positionGOOG),weight(positionAAPL)) 
##D plot(weight(positionC),weight(positionGOOG),weight(positionAAPL),
##D legend=c('C','GOOG','AAPL'),title='Weight')
## End(Not run)
