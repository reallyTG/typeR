...
### Name: ProfileLikelihood-package
### Title: Profile Likelihood for a Parameter in Commonly Used Statistical
###   Models
### Aliases: ProfileLikelihood-package ProfileLikelihood
### Keywords: profile likelihood profile likelihood plot likelihood support
###   interval
