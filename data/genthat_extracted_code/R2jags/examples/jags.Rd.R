...
#=============#
  ...
  ## NOT RUN HERE
  ## Not run: 
##D     jagsfit <- jags2(data=jags.data, inits=jags.inits, jags.params,
##D       n.iter=5000, model.file=model.file)
##D     print(jagsfit)
##D     plot(jagsfit)
##D     # or to use some plots in coda
##D     # use as.mcmmc to convert rjags object into mcmc.list
##D     jagsfit.mcmc <- as.mcmc.list(jagsfit)
##D     traceplot(jagsfit.mcmc)
##D     #require(lattice)
##D     #xyplot(jagsfit.mcmc)
##D     #densityplot(jagsfit.mcmc)
##D   
## End(Not run)
