...
### Name: boot.ROCt
### Title: Construction of a prognostic scoring system and estimation of
###   its true diagnostic capacities when the data are incomplete (right
###   censoring)
### Aliases: boot.ROCt
### Keywords: 0.632 bootstrap Time-dependent ROC curve
