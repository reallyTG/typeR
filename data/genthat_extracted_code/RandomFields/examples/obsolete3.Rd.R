...
### Name: Obsolete Functions Version 3
### Title: Obsolete functions Version 3
### Aliases: RFempiricalvariogram RFempiricalcovariance RFempiricalmadogram
###   RMstrokorbMono RMstrokorbBall RMstrokorbPoly
### Keywords: spatial
