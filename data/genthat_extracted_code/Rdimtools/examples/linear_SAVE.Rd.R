...
##D out1 = do.save(X, y, h=2)
##D out2 = do.save(X, y, h=5)
##D out3 = do.save(X, y, h=10)
##D 
##D ## visualize
##D par(mfrow=c(1,3))
##D plot(out1$Y[,1], out1$Y[,2], main="SAVE::2 slices")
##D plot(out2$Y[,1], out2$Y[,2], main="SAVE::5 slices")
##D plot(out3$Y[,1], out3$Y[,2], main="SAVE::10 slices")
## End(Not run)
