...
### Name: fm.FuzzyMeasureFitLPMob
### Title: Mobius Fuzzy Measure Fitting function, R wrapper for
###   FuzzyMeasureFitLP() in fuzzymeasurefit.cpp
### Aliases: fm.FuzzyMeasureFitLPMob
### Keywords: FuzzyMeasureFitLP FuzzyMeasureFitLPMob
