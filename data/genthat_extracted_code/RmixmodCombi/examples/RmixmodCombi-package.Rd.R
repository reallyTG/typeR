...
### Name: RmixmodCombi-package
### Title: Combining Mixture Components for Clustering
### Aliases: RmixmodCombi-package RmixmodCombi
### Keywords: cluster
...
## Not run: 
##D plot(res) # This is a simulated example where the clusters should obviously not be identified to 
##D # Gaussian components...
##D 
