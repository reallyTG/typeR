...
### Name: TML.censored.control.ref
### Title: Control parameters for the refinement IRLS algorithm of the
###   TML.censored initial S-estimates
### Aliases: TML.censored.control.ref
