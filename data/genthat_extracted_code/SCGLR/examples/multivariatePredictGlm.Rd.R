...
### Name: multivariatePredictGlm
### Title: Function that predicts the responses from the covariates for a
###   new sample
### Aliases: multivariatePredictGlm
### Keywords: internal
...
##D 
##D # remove "geology" and "surface" from nx as surface is
##D # offset and we want to use geology as additional covariate
...
##D # rhs parameters is introduced to take into account that the covariate
##D # of the formula is composed of two differents sets
...
##D 
##D # rhs parameters is introduced to take into account that the covariate
##D # part of the formula is composed of two differents sets
