...
### Name: SCRSELECTRETURN
### Title: Performs Bayesian Variable Selection on the covariates in a
###   semi-competing risks model and returns burned in posterior means of
###   parameters. This function is used in the ReturnModel function.
### Aliases: SCRSELECTRETURN
