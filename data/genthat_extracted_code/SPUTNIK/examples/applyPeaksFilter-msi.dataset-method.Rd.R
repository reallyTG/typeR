...
### Name: applyPeaksFilter,msi.dataset-method
### Title: Apply the results of a peaks filter.
### Aliases: applyPeaksFilter,msi.dataset-method
###   applyPeaksFilter-msi.dataset-method applyPeaksFilter
