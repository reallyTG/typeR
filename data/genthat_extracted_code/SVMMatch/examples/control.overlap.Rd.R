...
### Name: control.overlap
### Title: Assessing the number of control observations used in estimating
###   the treatment effect.
### Aliases: control.overlap
...
##D 
##D ##Assess ignorability:	
##D 	#Assess control overlap--are there enough
##D 	#controls to balance the treated?
##D 		cont1<-control.overlap(m1.param)	
##D 
##D 	
## End(Not run)
