...
### Name: treatment.overlap
### Title: Exploring hard-to-match treated observations.
### Aliases: treatment.overlap
...
##D 
##D 	#Assess treatment overlap--are there treated 
##D 	#values that can't be matched?
##D 		treat1<-treatment.overlap(m1.param)
##D 
##D 	
## End(Not run)
