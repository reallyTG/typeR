...
### Name: PrintAlignSubspaceParams
### Title: Print AlignSubspace Calculation Parameters
### Aliases: PrintAlignSubspaceParams
...
##D PrintAlignSubspaceParams(object = pbmc_small)
## End(Not run)
