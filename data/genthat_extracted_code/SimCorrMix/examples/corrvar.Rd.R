...
### Name: corrvar
### Title: Generation of Correlated Ordinal, Continuous (mixture and
###   non-mixture), and/or Count (Poisson and Negative Binomial, regular
###   and zero-inflated) Variables: Correlation Method 1
### Aliases: corrvar
...
##D   lam, p_zip, size, prob, mu = NULL, p_zinb, rho = Rey)
##D 
##D # check to make sure Rey is within the feasible correlation boundaries
##D validcorr(n, k_cat, k_cont, k_mix, k_pois, k_nb, "Polynomial", means,
##D   vars, skews, skurts, fifths, sixths, Six, mix_pis, mix_mus, mix_sigmas,
##D   mix_skews, mix_skurts, mix_fifths, mix_sixths, mix_Six, marginal,
##D   lam, p_zip, size, prob, mu = NULL, p_zinb, Rey, seed)
##D 
##D # simulate without the error loop
##D Sim2 <- corrvar(n, k_cat, k_cont, k_mix, k_pois, k_nb, "Polynomial", means,
##D   vars, skews, skurts, fifths, sixths, Six, mix_pis, mix_mus, mix_sigmas,
##D   mix_skews, mix_skurts, mix_fifths, mix_sixths, mix_Six, marginal, support,
##D   lam, p_zip, size, prob, mu = NULL, p_zinb, Rey, seed, epsilon = 0.01)
##D 
##D names(Sim2)
##D 
##D # simulate with the error loop
##D Sim2_EL <- corrvar(n, k_cat, k_cont, k_mix, k_pois, k_nb, "Polynomial",
##D   means, vars, skews, skurts, fifths, sixths, Six, mix_pis, mix_mus,
##D   mix_sigmas, mix_skews, mix_skurts, mix_fifths, mix_sixths, mix_Six,
##D   marginal, support, lam, p_zip, size, prob, mu = NULL, p_zinb, Rey,
##D   seed, errorloop = TRUE, epsilon = 0.01)
##D 
##D names(Sim2_EL)
## End(Not run)
