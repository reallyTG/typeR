...
###   and zero-inflated) Variables: Correlation Method 2
### Aliases: corrvar2
### Keywords: Fleishman Headrick NegativeBinomial Poisson continuous
###   method2 mixture ordinal simulation
...
##D Sim2 <- corrvar2(n, k_cat, k_cont, k_mix, k_pois, k_nb, "Polynomial", means,
##D   vars, skews, skurts, fifths, sixths, Six, mix_pis, mix_mus, mix_sigmas,
##D   mix_skews, mix_skurts, mix_fifths, mix_sixths, mix_Six, marginal, support,
##D   lam, p_zip, size, prob, mu = NULL, p_zinb, pois_eps, nb_eps, Rey, seed,
##D   epsilon = 0.01)
...
##D Sim2_EL <- corrvar2(n, k_cat, k_cont, k_mix, k_pois, k_nb, "Polynomial",
...
##D   marginal, support, lam, p_zip, size, prob, mu = NULL, p_zinb, pois_eps,
##D   nb_eps, Rey, seed, errorloop = TRUE, epsilon = 0.01)
##D 
##D names(Sim2_EL)
## End(Not run)
