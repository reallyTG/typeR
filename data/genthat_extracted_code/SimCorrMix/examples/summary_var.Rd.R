...
##D Sim1 <- corrvar(n, k_cat, k_cont, k_mix, k_pois, k_nb, "Polynomial", means,
##D   vars, skews, skurts, fifths, sixths, Six, mix_pis, mix_mus, mix_sigmas,
##D   mix_skews, mix_skurts, mix_fifths, mix_sixths, mix_Six, marginal, support,
##D   lam, p_zip, size, prob, mu = NULL, p_zinb, Rey, seed, epsilon = 0.01)
##D 
##D Summ1 <- summary_var(Sim1$Y_cat, Y_cont = NULL, Sim1$Y_comp, Sim1$Y_mix,
##D   Sim1$Y_pois, Sim1$Y_nb, means, vars, skews, skurts, fifths, sixths,
##D   mix_pis, mix_mus, mix_sigmas, mix_skews, mix_skurts, mix_fifths,
##D   mix_sixths, marginal, lam, p_zip, size, prob, mu = NULL, p_zinb, Rey)
##D 
##D Sim1_error <- abs(Rey - Summ1$rho_calc)
##D summary(as.numeric(Sim1_error))
##D 
## End(Not run)
