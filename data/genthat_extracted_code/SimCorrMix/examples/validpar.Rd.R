...
### Name: validpar
### Title: Parameter Check for Simulation or Correlation Validation
###   Functions
### Aliases: validpar
...
##D 
##D # use before contmixvar1 with 1st mixture variable:
##D # change mix_pis to not sum to 1
##D 
##D check1 <- validpar(k_mix = 1, method = "Polynomial", means = Nstcum[1],
##D   vars = Nstcum[2]^2, mix_pis = C(0.4, 0.5), mix_mus = mix_mus[[1]],
##D   mix_sigmas = mix_sigmas[[1]], mix_skews = mix_skews[[1]],
##D   mix_skurts = mix_skurts[[1]], mix_fifths = mix_fifths[[1]],
##D   mix_sixths = mix_sixths[[1]])
##D 
##D # use before validcorr: should return TRUE
##D 
##D check2 <- validpar(k_cat, k_cont, k_mix, k_pois, k_nb, "Polynomial", means,
