...
##D                      fifths = M[3, ], sixths = M[4, ],
##D                      marginal = marginal, lam = lam,
##D                      pois_eps = rep(0.0001, npois),
##D                      size = size, prob = prob,
##D                      nb_eps = rep(0.0001, nnb),
##D                      rho = Rey, seed = seed)
##D 
##D # Find intermediate correlation
##D Sigma2 <- findintercorr2(n = n, k_cont = ncont, k_cat = ncat,
##D                          k_pois = npois, k_nb = nnb,
##D                          method = "Polynomial", constants = con,
##D                          marginal = marginal, lam = lam, size = size,
##D                          prob = prob, pois_eps = rep(0.0001, npois),
##D                          nb_eps = rep(0.0001, nnb), rho = Rey)
##D Sigma2
##D 
## End(Not run)
