...
### Aliases: plot_sim_pdf_theory
### Keywords: Fleishman, Headrick pdf, plot, simulated, theoretical,
...
##D                        n = 10000, seed = seed)
##D 
##D # Plot pdfs of simulated variable (invalid) and theoretical distribution
##D plot_sim_pdf_theory(sim_y = Logvar1$continuous_variable,
##D                     title = "Invalid Logistic Simulated PDF",
...
##D 
##D # Plot pdfs of simulated variable (invalid) and theoretical distribution
##D plot_sim_pdf_theory(sim_y = Logvar2$continuous_variable,
##D                     title = "Valid Logistic Simulated PDF",
##D                     overlay = TRUE, Dist = "Logistic", params = c(0, 1))
##D 
...
##D plot_sim_pdf_theory(sim_y = NBvars$Neg_Bin_variable[, 1], overlay = TRUE,
