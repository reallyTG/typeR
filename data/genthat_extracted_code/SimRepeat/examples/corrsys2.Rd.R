...
###   Continuous, and/or Count Variables: Correlation Method 2
### Aliases: corrsys2
...
##D   mix_sixths, mix_Six, marginal, support, lam, p_zip, pois_eps, size, prob,
##D   mu, p_zinb, nb_eps, corr.x, corr.yx = list(), corr.e, same.var, subj.var,
##D   int.var, tint.var, betas.0, betas, betas.subj, betas.int, betas.t,
##D   betas.tint)
##D 
##D # Simulated system using correlation method 2
##D N <- corrsys2(n, M, Time, method, error_type, means, vars, skews, skurts,
##D   fifths, sixths, Six, mix_pis, mix_mus, mix_sigmas, mix_skews, mix_skurts,
##D   mix_fifths, mix_sixths, mix_Six, marginal, support, lam, p_zip, pois_eps,
##D   size, prob, mu, p_zinb, nb_eps, corr.x, corr.e, same.var, subj.var,
##D   int.var, tint.var, betas.0, betas, betas.subj, betas.int, betas.t,
##D   betas.tint, seed = seed, use.nearPD = FALSE)
##D 
