...
### Name: latent
### Title: Bayesian hierarchical models for spatial extremes
### Aliases: latent
### Keywords: htest
...
##D prop <- list(gev = c(1.2, 0.08, 0.08), ranges = c(0.7, 0.8, 0.7), smooths = c(0,0,0))
...
##D              n = 10000, burn.in = 5000, thin = 15)
##D mc
## End(Not run)
