...
### Name: disstree
### Title: Dissimilarity Tree
### Aliases: disstree print.disstree
...
## Not run: 
##D disstreedisplay(dt, image.fun = seqdplot, image.data = mvad.seq,
##D   ## Additional parameters passed to seqdplot
##D   with.legend = FALSE, axes = FALSE, ylab = "")
## End(Not run)
...
## Not run: 
##D disstreedisplay(dt, image.fun = myplotfunction, cex.main = 3,
##D   ## additional parameters passed to myplotfunction
##D   seqs = mvad.seq,
##D   ## additional parameters passed to seqiplot (through myplotfunction)
##D   with.legend = FALSE, axes = FALSE, idxs = 0, space = 0, ylab = "", border = NA)
## End(Not run)
