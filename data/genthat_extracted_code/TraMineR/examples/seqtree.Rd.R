...
### Name: seqtree
### Title: Tree structured analysis of a state sequence object.
### Aliases: seqtree
...
## Not run: 
##D seqtreedisplay(seqt, type="d", border=NA)
##D seqtreedisplay(seqt, type="I", sortv=cmdscale(mvad.dhd, k=1))
## End(Not run)
