...
colors.use<-color.map(alabama.cdp,alabama.cdp$pop2000)
plot(alabama.cdp,col=colors.use$colors)
#text(coordinates(alabama.cdp),alabama.cdp$name,cex=.3)
