...
colors.use<-color.map(arizona.cdp,arizona.cdp$pop2000)
plot(arizona.cdp,col=colors.use$colors)
#text(coordinates(arizona.cdp),arizona.cdp$name,cex=.3)
