...
colors.use<-color.map(arkansas.cdp,arkansas.cdp$pop2000)
plot(arkansas.cdp,col=colors.use$colors)
#text(coordinates(arkansas.cdp),arkansas.cdp$name,cex=.3)
