...
### Name: california.cdp
### Title: california.cdp
### Aliases: california.cdp
### Keywords: datasets
...
colors.use<-color.map(california.cdp,california.cdp$pop2000)
plot(california.cdp,col=colors.use$colors)
#text(coordinates(california.cdp),california.cdp$name,cex=.3)
