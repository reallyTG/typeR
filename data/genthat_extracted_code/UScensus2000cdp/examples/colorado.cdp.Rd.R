...
colors.use<-color.map(colorado.cdp,colorado.cdp$pop2000)
plot(colorado.cdp,col=colors.use$colors)
#text(coordinates(colorado.cdp),colorado.cdp$name,cex=.3)
