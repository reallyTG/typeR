...
colors.use<-color.map(delaware.cdp,delaware.cdp$pop2000)
plot(delaware.cdp,col=colors.use$colors)
#text(coordinates(delaware.cdp),delaware.cdp$name,cex=.3)
