...
colors.use<-color.map(florida.cdp,florida.cdp$pop2000)
plot(florida.cdp,col=colors.use$colors)
#text(coordinates(florida.cdp),florida.cdp$name,cex=.3)
