...
colors.use<-color.map(georgia.cdp,georgia.cdp$pop2000)
plot(georgia.cdp,col=colors.use$colors)
#text(coordinates(georgia.cdp),georgia.cdp$name,cex=.3)
