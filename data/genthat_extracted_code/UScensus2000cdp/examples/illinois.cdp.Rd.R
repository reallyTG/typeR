...
colors.use<-color.map(illinois.cdp,illinois.cdp$pop2000)
plot(illinois.cdp,col=colors.use$colors)
#text(coordinates(illinois.cdp),illinois.cdp$name,cex=.3)
