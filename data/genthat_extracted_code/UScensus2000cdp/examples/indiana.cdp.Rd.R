...
colors.use<-color.map(indiana.cdp,indiana.cdp$pop2000)
plot(indiana.cdp,col=colors.use$colors)
#text(coordinates(indiana.cdp),indiana.cdp$name,cex=.3)
