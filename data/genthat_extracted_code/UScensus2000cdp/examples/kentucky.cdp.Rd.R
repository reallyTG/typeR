...
colors.use<-color.map(kentucky.cdp,kentucky.cdp$pop2000)
plot(kentucky.cdp,col=colors.use$colors)
#text(coordinates(kentucky.cdp),kentucky.cdp$name,cex=.3)
