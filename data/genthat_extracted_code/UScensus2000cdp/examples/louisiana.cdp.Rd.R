...
colors.use<-color.map(louisiana.cdp,louisiana.cdp$pop2000)
plot(louisiana.cdp,col=colors.use$colors)
#text(coordinates(louisiana.cdp),louisiana.cdp$name,cex=.3)
