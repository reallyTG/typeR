...
colors.use<-color.map(maryland.cdp,maryland.cdp$pop2000)
plot(maryland.cdp,col=colors.use$colors)
#text(coordinates(maryland.cdp),maryland.cdp$name,cex=.3)
