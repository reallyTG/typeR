...
### Name: massachusetts.cdp
### Title: massachusetts.cdp
### Aliases: massachusetts.cdp
### Keywords: datasets

### ** Examples

data(massachusetts.cdp)
...
colors.use<-color.map(massachusetts.cdp,massachusetts.cdp$pop2000)
plot(massachusetts.cdp,col=colors.use$colors)
#text(coordinates(massachusetts.cdp),massachusetts.cdp$name,cex=.3)
