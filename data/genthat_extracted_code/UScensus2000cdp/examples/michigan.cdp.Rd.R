...
colors.use<-color.map(michigan.cdp,michigan.cdp$pop2000)
plot(michigan.cdp,col=colors.use$colors)
#text(coordinates(michigan.cdp),michigan.cdp$name,cex=.3)
