...
colors.use<-color.map(minnesota.cdp,minnesota.cdp$pop2000)
plot(minnesota.cdp,col=colors.use$colors)
#text(coordinates(minnesota.cdp),minnesota.cdp$name,cex=.3)
