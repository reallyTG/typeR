...
### Name: mississippi.cdp
### Title: mississippi.cdp
### Aliases: mississippi.cdp
### Keywords: datasets
...
colors.use<-color.map(mississippi.cdp,mississippi.cdp$pop2000)
plot(mississippi.cdp,col=colors.use$colors)
#text(coordinates(mississippi.cdp),mississippi.cdp$name,cex=.3)
