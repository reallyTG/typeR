...
colors.use<-color.map(missouri.cdp,missouri.cdp$pop2000)
plot(missouri.cdp,col=colors.use$colors)
#text(coordinates(missouri.cdp),missouri.cdp$name,cex=.3)
