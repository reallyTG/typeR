...
colors.use<-color.map(montana.cdp,montana.cdp$pop2000)
plot(montana.cdp,col=colors.use$colors)
#text(coordinates(montana.cdp),montana.cdp$name,cex=.3)
