...
colors.use<-color.map(nebraska.cdp,nebraska.cdp$pop2000)
plot(nebraska.cdp,col=colors.use$colors)
#text(coordinates(nebraska.cdp),nebraska.cdp$name,cex=.3)
