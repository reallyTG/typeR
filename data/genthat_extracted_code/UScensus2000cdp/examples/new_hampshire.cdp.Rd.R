...
### Name: new_hampshire.cdp
### Title: new_hampshire.cdp
### Aliases: new_hampshire.cdp
### Keywords: datasets

### ** Examples

data(new_hampshire.cdp)
...
colors.use<-color.map(new_hampshire.cdp,new_hampshire.cdp$pop2000)
plot(new_hampshire.cdp,col=colors.use$colors)
#text(coordinates(new_hampshire.cdp),new_hampshire.cdp$name,cex=.3)
