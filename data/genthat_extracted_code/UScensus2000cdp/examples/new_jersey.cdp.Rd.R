...
### Name: new_jersey.cdp
### Title: new_jersey.cdp
### Aliases: new_jersey.cdp
### Keywords: datasets
...
#text(coordinates(new_jersey.cdp),new_jersey.cdp$name,cex=.3)
