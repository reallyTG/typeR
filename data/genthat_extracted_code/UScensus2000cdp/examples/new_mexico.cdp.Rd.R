...
### Name: new_mexico.cdp
### Title: new_mexico.cdp
### Aliases: new_mexico.cdp
### Keywords: datasets
...
colors.use<-color.map(new_mexico.cdp,new_mexico.cdp$pop2000)
plot(new_mexico.cdp,col=colors.use$colors)
#text(coordinates(new_mexico.cdp),new_mexico.cdp$name,cex=.3)
