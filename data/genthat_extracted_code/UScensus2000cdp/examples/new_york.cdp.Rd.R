...
colors.use<-color.map(new_york.cdp,new_york.cdp$pop2000)
plot(new_york.cdp,col=colors.use$colors)
#text(coordinates(new_york.cdp),new_york.cdp$name,cex=.3)
