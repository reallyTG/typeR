...
colors.use<-color.map(oklahoma.cdp,oklahoma.cdp$pop2000)
plot(oklahoma.cdp,col=colors.use$colors)
#text(coordinates(oklahoma.cdp),oklahoma.cdp$name,cex=.3)
