...
### Name: rhode_island.cdp
### Title: rhode_island.cdp
### Aliases: rhode_island.cdp
### Keywords: datasets

### ** Examples

data(rhode_island.cdp)
...
colors.use<-color.map(rhode_island.cdp,rhode_island.cdp$pop2000)
plot(rhode_island.cdp,col=colors.use$colors)
#text(coordinates(rhode_island.cdp),rhode_island.cdp$name,cex=.3)
