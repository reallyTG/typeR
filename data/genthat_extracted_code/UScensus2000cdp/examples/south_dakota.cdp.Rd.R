...
### Name: south_dakota.cdp
### Title: south_dakota.cdp
### Aliases: south_dakota.cdp
### Keywords: datasets

### ** Examples

data(south_dakota.cdp)
...
colors.use<-color.map(south_dakota.cdp,south_dakota.cdp$pop2000)
plot(south_dakota.cdp,col=colors.use$colors)
#text(coordinates(south_dakota.cdp),south_dakota.cdp$name,cex=.3)
