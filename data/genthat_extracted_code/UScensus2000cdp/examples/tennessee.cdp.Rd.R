...
colors.use<-color.map(tennessee.cdp,tennessee.cdp$pop2000)
plot(tennessee.cdp,col=colors.use$colors)
#text(coordinates(tennessee.cdp),tennessee.cdp$name,cex=.3)
