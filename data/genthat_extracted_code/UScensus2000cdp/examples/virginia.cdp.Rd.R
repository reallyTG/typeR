...
colors.use<-color.map(virginia.cdp,virginia.cdp$pop2000)
plot(virginia.cdp,col=colors.use$colors)
#text(coordinates(virginia.cdp),virginia.cdp$name,cex=.3)
