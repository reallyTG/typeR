...
### Name: washington.cdp
### Title: washington.cdp
### Aliases: washington.cdp
### Keywords: datasets
...
colors.use<-color.map(washington.cdp,washington.cdp$pop2000)
plot(washington.cdp,col=colors.use$colors)
#text(coordinates(washington.cdp),washington.cdp$name,cex=.3)
