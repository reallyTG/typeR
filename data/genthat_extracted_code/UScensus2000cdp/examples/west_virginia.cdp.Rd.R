...
### Name: west_virginia.cdp
### Title: west_virginia.cdp
### Aliases: west_virginia.cdp
### Keywords: datasets

### ** Examples

data(west_virginia.cdp)
...
colors.use<-color.map(west_virginia.cdp,west_virginia.cdp$pop2000)
plot(west_virginia.cdp,col=colors.use$colors)
#text(coordinates(west_virginia.cdp),west_virginia.cdp$name,cex=.3)
