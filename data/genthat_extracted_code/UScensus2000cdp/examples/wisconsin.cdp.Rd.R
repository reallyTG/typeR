...
colors.use<-color.map(wisconsin.cdp,wisconsin.cdp$pop2000)
plot(wisconsin.cdp,col=colors.use$colors)
#text(coordinates(wisconsin.cdp),wisconsin.cdp$name,cex=.3)
