...
colors.use<-color.map(wyoming.cdp,wyoming.cdp$pop2000)
plot(wyoming.cdp,col=colors.use$colors)
#text(coordinates(wyoming.cdp),wyoming.cdp$name,cex=.3)
