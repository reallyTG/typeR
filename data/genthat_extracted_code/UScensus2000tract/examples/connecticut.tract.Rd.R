...
### Name: connecticut.tract
### Title: connecticut.tract
### Aliases: connecticut.tract
### Keywords: datasets
...
colors.use<-color.map(connecticut.tract,connecticut.tract$pop2000)
plot(connecticut.tract,col=colors.use$colors)
#text(coordinates(connecticut.tract),connecticut.tract@data$name,cex=.3)
