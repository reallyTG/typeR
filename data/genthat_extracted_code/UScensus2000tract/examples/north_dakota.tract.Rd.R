...
### Name: north_dakota.tract
### Title: north_dakota.tract
### Aliases: north_dakota.tract
### Keywords: datasets

### ** Examples

data(north_dakota.tract)
...
colors.use<-color.map(north_dakota.tract,north_dakota.tract$pop2000)
plot(north_dakota.tract,col=colors.use$colors)
#text(coordinates(north_dakota.tract),north_dakota.tract@data$name,cex=.3)
