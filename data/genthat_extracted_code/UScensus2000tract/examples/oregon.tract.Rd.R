...
colors.use<-color.map(oregon.tract,oregon.tract$pop2000)
plot(oregon.tract,col=colors.use$colors)
#text(coordinates(oregon.tract),oregon.tract@data$name,cex=.3)
