...
### Name: uhlig.reject
### Title: Uhlig's (2005) rejection method
### Aliases: uhlig.reject
### Keywords: ts models
...
##D model1 <- uhlig.reject(Y=uhligdata, nlags=12, draws=200, subdraws=200, nkeep=1000, KMIN=1,
##D                         KMAX=6, constrained=constr, constant=FALSE, steps=60)
##D 
##D # get posterior draws
##D irfs1 <- model1$IRFS
##D 
##D # plot impulse response functions
##D irfplot(irfdraws=irfs1,type="median", labels=vl, save=FALSE, bands=c(0.16, 0.84),
