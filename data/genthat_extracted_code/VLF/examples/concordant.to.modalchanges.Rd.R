...
### Name: concordant.to.modalchanges
### Title: Concordant Residue Changes
### Aliases: concordant.to.modalchanges
...
##D concordant_aaType_change <- concordant.to.modalchanges(matching_comparison, aminoAcid_Modal)
## End(Not run)
