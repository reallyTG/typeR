...
### Name: matched.codon.position
### Title: Codon Position of Matching aa and ntVLFs
### Aliases: matched.codon.position
...
##D matching_codons <- matched.codon.position(matching_comparison)
## End(Not run)
