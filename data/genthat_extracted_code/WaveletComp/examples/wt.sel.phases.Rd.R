...
### Name: wt.sel.phases
### Title: Plot phases for selected periodic components of a single time
###   series
### Aliases: wt.sel.phases
### Keywords: ts
...
##D 
##D ## Select period 8 and plot corresponding phases across time:
##D wt.sel.phases(my.wt, sel.period = 8)
##D 
...
##D 
##D ## In the following, no period is selected.
##D ## By setting 'show.avg.phase = TRUE', the plot shows average phases 
##D ## instead of individual phases: 
##D wt.sel.phases(my.wt, show.avg.phase = TRUE)
##D 
## End(Not run)
