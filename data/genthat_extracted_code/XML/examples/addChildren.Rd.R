...
###   removeNodes.list removeNodes.XMLNodeSet removeNodes.XMLNodeList
###   removeNodes.XMLInternalNode replaceNodes addAttributes
###   removeAttributes addChildren,XMLInternalNode-method
