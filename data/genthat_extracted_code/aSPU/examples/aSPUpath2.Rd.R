...
###   (vector version, fast when n is large)
### Aliases: aSPUpath2
...
## Not run: 
##D p.pathaspu<- aSPUpath2(dat1$Y, dat1$X, snp.info = dat1$snp.info,
##D          gene.info = dat1$gene.info,
##D          model = "binomial", pow=1:8, pow2=c(1, 2, 4, 8), n.perm=1000) 
## End(Not run)
## Don't show: 
p.pathaspu<- aSPUpath2(dat1$Y, dat1$X, snp.info = dat1$snp.info,
