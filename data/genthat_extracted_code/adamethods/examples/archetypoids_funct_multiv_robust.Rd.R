...
### Name: archetypoids_funct_multiv_robust
### Title: Archetypoid algorithm with the functional multivariate robust
###   Frobenius norm
...
##D Xs[,,2] <- scale(X[,,2])
##D 
##D lass <- stepArchetypesRawData_funct_multiv_robust(data = Xs, numArch = 3, 
##D                                                   numRep = 5, verbose = FALSE, 
##D                                                   saveHistory = FALSE, PM, prob = 0.8, 
##D                                                   nbasis, nvars)
##D 
##D afmr <- archetypoids_funct_multiv_robust(3, Xs, huge = 200, ArchObj = lass, PM, 0.8)
##D str(afmr)
## End(Not run)                                                          
