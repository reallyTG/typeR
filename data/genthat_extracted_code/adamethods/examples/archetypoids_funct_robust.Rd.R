...
### Name: archetypoids_funct_robust
### Title: Archetypoid algorithm with the functional robust Frobenius norm
...
##D 
##D afr <- archetypoids_funct_robust(3, data_archs, huge = 200, ArchObj = lass, PM, 0.8)
##D str(afr)
## End(Not run)                                                          
