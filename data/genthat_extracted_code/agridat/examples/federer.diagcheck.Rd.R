...
### Name: federer.diagcheck
### Title: Wheat experiment with diagonal checks
### Aliases: federer.diagcheck
### Keywords: datasets
...
##D   require(asreml)
##D   require(lucid)
##D   m3 <- asreml(yield ~ -1 + trtn, data=dat,
##D                random = ~ r1 + r2 + r4 + r8 + r10 +
##D                  c1 + c2 + c3 + c4 + c6 + c8 + r1:c1 + r1:c2 + r1:c3 + new:gen)
##D   coef(m3)
##D   # REML cultivar means.  Very similar to Federer table 2.
##D   rev(sort(round(coef(m3)$fixed[3] + coef(m3)$random[137:256,],0)))
##D   ## gen_G060 gen_G021 gen_G011 gen_G099 gen_G002
##D   ##      974      949      945      944      942
##D   ## gen_G118 gen_G058 gen_G035 gen_G111 gen_G120
##D   ##      938      937      937      933      932
##D   ## gen_G046 gen_G061 gen_G082 gen_G038 gen_G090
##D   ##      932      931      927      927      926
##D 
##D   vc(m3)
##D   ##           effect component std.error z.ratio constr
##D   ##        r1!r1.var   9201        13720    0.67    pos
##D   ##        r2!r2.var    241.7       1059    0.23    pos
##D   ##        r4!r4.var   2269         3915    0.58    pos
##D   ##        r8!r8.var   1355         2627    0.52    pos
##D   ##      r10!r10.var   1133         2312    0.49    pos
##D   ##        c1!c1.var      0.01         0    4.8   bound
##D   ##        c2!c2.var   5942         8969    0.66    pos
##D   ##        c3!c3.var   2549         4177    0.61    pos
##D   ##        c4!c4.var   1792         3106    0.58    pos
##D   ##        c6!c6.var   1400         2551    0.55    pos
##D   ##        c8!c8.var   6456         9702    0.67    pos
##D   ##     r1:c1!r1.var 128000       189700    0.67    pos
##D   ##     r1:c2!r1.var  58230        90820    0.64    pos
##D   ##     r1:c3!r1.var   5531        16550    0.33    pos
##D   ##  new:gen!new.var   2869         1367    2.1     pos
##D   ##       R!variance   4412          915    4.8     pos
##D 
## End(Not run)
