...
## Not run: 
##D # Compute probability P(X \in (-\infty,0]) with X~N(0,Sigma)
...
##D 
##D pANMC<-ProbaMax(cBdg=20, q=min(50,d/2), E=seq(0,1,,d), threshold=0, mu=mu, Sigma=Sigma,
...
##D 
##D 
##D # Implement ProbaMax with user defined function for active dimension probability estimate
##D if(!requireNamespace("TruncatedNormal", quietly = TRUE)) {
##D stop("Package TruncatedNormal needed for this example to work. Please install it.",
##D      call. = FALSE)
##D }
##D 
