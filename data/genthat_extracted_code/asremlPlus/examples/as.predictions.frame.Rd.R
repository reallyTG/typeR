...
### Name: as.predictions.frame
### Title: Forms a 'predictions.frame' from a 'data.frame', ensuring that
###   the correct columns are present.
### Aliases: as.predictions.frame
...
##D  #Form predictions.frame changing asreml-R4 names to the standard names, if these are present
