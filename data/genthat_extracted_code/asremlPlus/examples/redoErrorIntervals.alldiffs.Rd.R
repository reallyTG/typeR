...
### Name: redoErrorIntervals.alldiffs
### Title: Adds or replaces the error intervals stored in a prediction
###   component of an 'alldiffs.object'.
### Aliases: redoErrorIntervals.alldiffs redoErrorIntervals
### Keywords: asreml
