...
### Name: ceSimErrorsUnequalGLECI
### Title: Simulate GLECI under combined group and individual location
###   errors with unequal observation probabilities
### Aliases: ceSimErrorsUnequalGLECI
