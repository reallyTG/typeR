...
### Name: ceSimErrorsUnequalHWI
### Title: Simulate HWI under combined group and individual location errors
###   with unequal observation probabilities
### Aliases: ceSimErrorsUnequalHWI
