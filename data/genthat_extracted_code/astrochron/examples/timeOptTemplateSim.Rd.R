...
### Name: timeOptTemplateSim
### Title: Simulations for timeOptTemplate
### Aliases: timeOptTemplateSim
...
##D # view optimization procedure
##D timeOptTemplate(ex2,template=template,sedmin=2.75,sedmax=3.25,numsed=20,ncores=1,genplot=2)
##D 
...
##D timeOpt(ex2,sedmin=1,sedmax=4,numsed=100)
##D # then with the timeOptTemplate approach
##D # create a constant sedimentation rate model with possible hiatus of unknown
##D #  duration at 10 m
...
##D res=timeOptTemplate(ex2,template=template,sedmin=1.5,sedmax=2,difmax=3,numsed=100,ncores=2,
##D  iopt=2,output=2)
