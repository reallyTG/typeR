...
### Name: autoencoder-package
### Title: Implementation of sparse autoencoder for automatic learning of
###   representative features from unlabeled data.
### Aliases: autoencoder-package autoencoder
### Keywords: deep learning, autoencoder, deep belief network
