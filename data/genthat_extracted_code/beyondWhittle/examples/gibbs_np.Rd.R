...
### Name: gibbs_np
### Title: Gibbs sampler for Bayesian nonparametric inference with Whittle
###   likelihood
### Aliases: gibbs_np
...
##D 
##D ##
##D ## Example 1: Fit the NP model to sunspot data:
##D ##
##D 
...
##D mcmc <- gibbs_np(data=data, Ntotal=10000, burnin=4000, thin=2)
##D 
...
##D 
##D ##
##D ## Example 2: Fit the NP model to high-peaked AR(1) data
##D ##
##D 
##D n <- 256
