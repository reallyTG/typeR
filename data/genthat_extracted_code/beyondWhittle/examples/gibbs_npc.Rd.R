...
### Name: gibbs_npc
### Title: Gibbs sampler for Bayesian semiparametric inference with the
###   corrected AR likelihood
### Aliases: gibbs_npc
...
##D 
##D ##
##D ## Example 1: Fit a nonparametrically corrected AR(p) model to sunspot data:
##D ##
##D 
...
##D mcmc <- gibbs_npc(data=data, ar.order=p, Ntotal=10000, burnin=4000, thin=2)
##D 
...
##D 
##D ##
##D ## Example 2: Fit a nonparametrically corrected AR(p) model to high-peaked AR(1) data
##D ##
##D 
##D # Use this variable to set the autoregressive model order
##D p <- 1
##D 
##D n <- 256
