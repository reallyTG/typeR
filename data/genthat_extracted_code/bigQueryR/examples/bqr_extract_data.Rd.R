...
### Name: bqr_extract_data
### Title: Extract data asynchronously
### Aliases: bqr_extract_data
...
##D bqr_get_job("your_project", job)
##D 
...
##D 
##D You should also see the extract in the Google Cloud Storage bucket
##D googleCloudStorageR::gcs_list_objects("your_cloud_storage_bucket_name")
##D 
