...
##D 
##D ## estimation
##D my_model <- BM_bernoulli_covariates_fast("SBM",M,list(Y1,Y2) )
##D my_model$estimate()
...
##D 
##D ## estimation
##D my_model <- BM_bernoulli_covariates_fast("SBM_sym",M,list(Y1,Y2) )
##D my_model$estimate()
##D which.max(my_model$ICL)
##D 
##D 
...
##D 
##D ## estimation
##D my_model <- BM_bernoulli_covariates_fast("LBM",M,list(Y1,Y2) )
##D my_model$estimate()
##D which.max(my_model$ICL)
## End(Not run)
