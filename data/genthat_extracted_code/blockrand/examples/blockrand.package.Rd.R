...
### Name: blockrand-package
### Title: Generate block randomizations for clinical trials.
### Aliases: blockrand-package
### Keywords: package
...
##D    bottom="Call 123-4567 to report patient entry")
##D 
##D plotblockrand(my.study, 'mystudy.pdf', cut.marks=TRUE)
## End(Not run)
