...
### Name: bmixture-package
### Title: Bayesian Estimation for Finite Mixture of Distributions
### Aliases: bmixture-package ' bmixnorm_unknown_k ' ' bmixnorm_fixed_k '
### Keywords: Package, bmixture, Mixture distributions, Bayesian model
###   selection
...
##D data( galaxy )
##D 
##D # Runing bdmcmc algorithm for the galaxy dataset      
##D mcmc_sample = bmixnorm( data = galaxy )
##D 
##D summary( mcmc_sample ) 
##D plot( mcmc_sample )
##D print( mcmc_sample)
##D 
