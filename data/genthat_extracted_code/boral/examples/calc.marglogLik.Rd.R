...
### Title: Marginal log-likelihood for an boral model
### Aliases: calc.marglogLik
...
##D     2,median))
##D      
##D ## Calculate the marginal log-likelihood at the posterior median
##D calc.marglogLik(y, family = "negative.binomial",
##D     lv.coefs = coef_mat, row.eff = "fixed", row.params = site_coef, 
##D     num.lv = 2)
##D 
##D 	
##D ## Example 2 - model with one latent variable, no site effects, 
...
##D calc.marglogLik(y, X = spider$x, family = "negative.binomial", 
##D     lv.coefs = coef_mat, X.coefs = X_coef_mat, num.lv = 2)	
## End(Not run)
