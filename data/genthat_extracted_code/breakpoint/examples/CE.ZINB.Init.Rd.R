...
###   Zero-Inflated Negative Binomial Distribution with initial locations
### Aliases: CE.ZINB.Init
...
##D 
##D init.loci <- c(1400, 3400, 4650, 7100, 8200)
##D 
##D obj1 <- CE.ZINB.Init(simdata, init.locs = init.loci, distyp = 1, penalty = BIC, parallel = TRUE)
##D obj1
##D 
...
##D 
##D obj2 <- CE.ZINB.Init(simdata, init.locs = init.loci, distyp = 2, penalty = BIC, parallel = TRUE)
##D obj2
##D 
