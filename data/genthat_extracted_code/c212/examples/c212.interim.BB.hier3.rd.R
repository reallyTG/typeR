...
### Name: c212.interim.BB.hier3
### Title: A Three-Level Hierarchical Body-system based Model for interim
###   analysis with Point-Mass.
### Aliases: c212.interim.BB.hier3
### Keywords: c212.interim.BB.hier3 Bayesian Hierarchy Point-mass Berry and
###   Berry
...
##D raw = c212.interim.1a.hier3(c212.trial.interval.data1, level = 1)
##D 
##D raw$B
##D      [,1]        [,2]         [,3]         [,4]         [,5]        
