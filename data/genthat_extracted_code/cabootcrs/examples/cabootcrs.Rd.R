...
### Name: cabootcrs
### Title: Calculate category point variances using bootstrapping
### Aliases: cabootcrs
...
##D 
##D # Use 10000 bootstrap replicates, which is recommended if the machine is 
##D # fast enough but the difference is usually fairly small.
##D 
##D bd10k <- cabootcrs(DreamData, nboots=10000)
##D 
##D # Use multinomial resampling, with the matrix treated as a single
##D # multinomial distribution. 
##D 
##D bdm <- cabootcrs(DreamData, resampledistn="multinomial")
##D 
##D # Fix the row sums (i.e. keep sum of age group constant).
##D 
##D bdmrf <- cabootcrs(DreamData, resampledistn="multinomial", multinomialtype="rowsfixed")
##D 
##D # Just perform correspondence analysis, without bootstrapping.
##D 
##D bd0 <- cabootcrs(DreamData, nboots=0)
## End(Not run)
