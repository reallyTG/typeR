...
### Name: Closure class
### Title: Class "closure" for storing the result of the closed testing
###   procedure
### Aliases: closure closure-class show,closure-method
###   summary,closure-method defining defining,closure-method shortlist
###   shortlist,closure-method hypotheses hypotheses,closure-method
###   alpha,closure-method alpha<-,closure-method alpha<- alpha
### Keywords: methods
