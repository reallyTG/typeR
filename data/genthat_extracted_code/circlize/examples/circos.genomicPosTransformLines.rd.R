...
### Name: circos.genomicPosTransformLines
### Title: Add genomic position transformation lines between tracks
### Aliases: circos.genomicPosTransformLines
...
##D     circos.genomicText(region, value, y = 0, adj = c(1, 0.5),
##D         labels = "gene", facing = "reverse.clockwise",
##D         posTransform = posTransform.default)
##D }, bg.border = NA)
##D 
##D circos.genomicPosTransformLines(bed, posTransform = posTransform.default,
