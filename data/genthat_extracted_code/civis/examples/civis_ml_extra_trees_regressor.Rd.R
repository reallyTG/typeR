...
### Name: civis_ml_extra_trees_regressor
### Title: CivisML Extra Trees Regressor
### Aliases: civis_ml_extra_trees_regressor
...
##D data(ChickWeight)
##D 
##D m <- civis_ml_extra_trees_regressor(ChickWeight,
