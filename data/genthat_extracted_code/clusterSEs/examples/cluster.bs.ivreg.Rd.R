...
### Name: cluster.bs.ivreg
### Title: Pairs Cluster Bootstrapped p-Values For Regression With
###   Instrumental Variables
### Aliases: cluster.bs.ivreg
...
##D cluster.bs.c <- cluster.bs.ivreg(fm, dat = CigarettesSW, cluster = ~state, report = T)
##D 
##D 
##D ################################################
...
##D cluster.bs.e <- cluster.bs.ivreg(mod = emp.iv, dat = EmplUK, cluster = ~firm)
##D 
## End(Not run)
