...
### Name: findwithinss.sc.dp
### Title: Finding Optimal Withinss in Clustering Multidimensional Data
###   with Sequential Constraint by Dynamic Programming
### Aliases: findwithinss.sc.dp
