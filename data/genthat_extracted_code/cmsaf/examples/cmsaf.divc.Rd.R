...
## Divide each dataset element of the example CM SAF NetCDF file by 
## a given number and write the output to a new file.
   cmsaf.divc('SIS', 100, 'CMSAF_example_file.nc', 
   'CMSAF_example_file_cmsaf.divc.nc')
