...
## Determine the annual anomalies of the example CM SAF NetCDF file 
## and write the output to a new file.
   year.anomaly('SIS','CMSAF_example_file.nc', 
   'CMSAF_example_file_year.anomaly.nc')
