...
### Name: configr
### Title: configr package implements the YAML parser, JSON parser, INI
###   parser and TOML parser for R setting and writing of configuration
###   file.
### Aliases: configr configr-package
