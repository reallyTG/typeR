...
### Aliases: svyqsr svyqsr.survey.design svyqsr.svyrep.design
###   svyqsr.DBIsvydesign
### Keywords: survey
...
##D svyqsr( ~ db090 , design = des_eusilc )
##D svyqsr( ~ db090 , design = des_eusilc , na.rm = TRUE )
##D # replicate-weighted design using a variable with missings
##D svyqsr( ~ db090 , design = des_eusilc_rep )
##D svyqsr( ~ db090 , design = des_eusilc_rep , na.rm = TRUE )
##D 
...
##D 
##D svyqsr( ~ eqincome , design = dbd_eusilc )
##D 
