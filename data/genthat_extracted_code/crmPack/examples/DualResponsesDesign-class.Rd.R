...
### Name: DualResponsesDesign-class
...
###   'ModelEff' model class without DLE and efficacy samples. It contain
###   all slots in 'RuleDesign' and 'TDDesign' class object
### Aliases: DualResponsesDesign-class .DualResponsesDesign
### Keywords: class
