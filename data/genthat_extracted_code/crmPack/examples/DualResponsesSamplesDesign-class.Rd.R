...
### Name: DualResponsesSamplesDesign-class
### Title: This is a class of design based on DLE responses using the
###   'LogisticIndepBeta' model model and efficacy responses using
###   'ModelEff' model class with DLE and efficacy samples.It contain all
###   slots in 'RuleDesign' and 'TDsamplesDesign' class object
### Aliases: DualResponsesSamplesDesign-class .DualResponsesSamplesDesign
### Keywords: class
