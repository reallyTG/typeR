...
### Name: LogisticLogNormalMixture-class
### Title: Standard logistic model with online mixture of two bivariate log
###   normal priors
### Aliases: LogisticLogNormalMixture-class .LogisticLogNormalMixture
### Keywords: classes
