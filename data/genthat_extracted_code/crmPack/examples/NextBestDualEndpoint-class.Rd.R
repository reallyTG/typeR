...
### Name: NextBestDualEndpoint-class
### Title: The class with the input for finding the next dose based on the
###   dual endpoint model
### Aliases: NextBestDualEndpoint-class .NextBestDualEndpoint
### Keywords: classes
