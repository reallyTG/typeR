...
### Name: TDsamplesDesign-class
### Title: This is a class of design based only on DLE responses using the
###   'LogisticIndepBeta' class model and DLE samples are also used.  In
###   addition to the slots in the more simple 'RuleDesign', objects of
###   this class contain:
### Aliases: TDsamplesDesign-class .TDsamplesDesign
### Keywords: class
