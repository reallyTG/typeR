...
### Name: dose
### Title: Compute the doses for a given probability, given model and
###   samples
### Aliases: dose dose,numeric,Model,Samples-method
###   dose,numeric,ModelTox,Samples-method
###   dose,numeric,ModelTox,missing-method
### Keywords: methods
