...
### Name: fitGain
### Title: Get the fiited values for the gain values at all dose levels
###   based on a given pseudo DLE model, DLE sample, a pseudo efficacy
###   model, a Efficacy sample and data. This method returns a data frame
###   with dose, middle, lower and upper quantiles of the gain value
###   samples
### Aliases: fitGain
