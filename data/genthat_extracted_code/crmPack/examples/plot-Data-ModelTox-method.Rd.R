...
### Name: plot,Data,ModelTox-method
### Title: Plot of the fitted dose-tox based with a given pseudo DLE model
###   and data without samples
### Aliases: plot,Data,ModelTox-method
### Keywords: methods
