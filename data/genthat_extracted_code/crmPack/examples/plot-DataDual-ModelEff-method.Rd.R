...
### Name: plot,DataDual,ModelEff-method
### Title: Plot of the fitted dose-efficacy based with a given pseudo
###   efficacy model and data without samples
### Aliases: plot,DataDual,ModelEff-method
### Keywords: methods
