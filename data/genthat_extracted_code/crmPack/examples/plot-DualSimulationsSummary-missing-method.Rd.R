...
### Name: plot,DualSimulationsSummary,missing-method
### Title: Plot summaries of the dual-endpoint design simulations
### Aliases: plot,DualSimulationsSummary,missing-method
### Keywords: methods
