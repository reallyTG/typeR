...
### Name: plot,PseudoDualFlexiSimulations,missing-method
...
###   plots at the moment are: trajectory Summary of the trajectory of the
###   simulated trials dosesTried Average proportions of the doses tested
###   in patients sigma2 The variance of the efficacy responses sigma2betaW
###   The variance of the random walk model You can specify one or both of
###   these in the 'type' argument.
### Aliases: plot,PseudoDualFlexiSimulations,missing-method
### Keywords: methods
