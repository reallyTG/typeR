...
### Name: plotDualResponses
### Title: Plot of the DLE and efficacy curve side by side given a DLE
###   pseudo model, a DLE sample, an efficacy pseudo model and a given
###   efficacy sample
### Aliases: plotDualResponses
