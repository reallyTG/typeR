...
### Name: plotGain
### Title: Plot the gain curve in addition with the dose-DLE and
###   dose-efficacy curve using a given DLE pseudo model, a DLE sample, a
###   given efficacy pseudo model and an efficacy sample
### Aliases: plotGain plotGain,ModelTox,Samples,ModelEff,Samples-method
