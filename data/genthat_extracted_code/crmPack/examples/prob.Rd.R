...
### Name: prob
### Title: Compute the probability for a given dose, given model and
###   samples
### Aliases: prob prob,numeric,Model,Samples-method
###   prob,numeric,ModelTox,Samples-method
###   prob,numeric,ModelTox,missing-method
### Keywords: methods
