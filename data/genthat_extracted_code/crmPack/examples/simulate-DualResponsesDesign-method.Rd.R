...
### Name: simulate,DualResponsesDesign-method
...
###   'DualResponsesDesign' where DLEmodel used are of 'ModelTox' class
###   object and efficacy model used are of 'ModelEff' class object. In
###   addition, no DLE and efficacy samples are involved or generated in
###   the simulation process
### Aliases: simulate,DualResponsesDesign-method
### Keywords: methods
