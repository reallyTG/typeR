...
### Name: simulate,DualResponsesSamplesDesign-method
### Title: This is a methods to simulate dose escalation procedure using
###   both DLE and efficacy responses. This is a method based on the
###   'DualResponsesSamplesDesign' where DLEmodel used are of 'ModelTox'
###   class object and efficacy model used are of 'ModelEff' class object
###   (special case is 'EffFlexi' class model object).  In addition, DLE
###   and efficacy samples are involved or generated in the simulation
###   process
### Aliases: simulate,DualResponsesSamplesDesign-method
### Keywords: methods
