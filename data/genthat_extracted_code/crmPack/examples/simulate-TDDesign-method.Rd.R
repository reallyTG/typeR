...
### Name: simulate,TDDesign-method
### Title: This is a methods to simulate dose escalation procedure only
###   using the DLE responses. This is a method based on the 'TDDesign'
###   where model used are of 'ModelTox' class object and no samples are
###   involved.
### Aliases: simulate,TDDesign-method
