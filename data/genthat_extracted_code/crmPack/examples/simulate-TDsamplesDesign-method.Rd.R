...
### Name: simulate,TDsamplesDesign-method
### Title: This is a methods to simulate dose escalation procedure only
###   using the DLE responses. This is a method based on the
###   'TDsamplesDesign' where model used are of 'ModelTox' class object DLE
###   samples are also used
### Aliases: simulate,TDsamplesDesign-method
