...
### Name: size
### Title: Determine the size of the next cohort
### Aliases: size size,CohortSizeRange,ANY,Data-method
###   size,CohortSizeDLT,ANY,Data-method size,CohortSizeMax,ANY,Data-method
