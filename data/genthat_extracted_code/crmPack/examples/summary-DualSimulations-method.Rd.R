...
### Name: summary,DualSimulations-method
### Title: Summarize the dual-endpoint design simulations, relative to
###   given true dose-toxicity and dose-biomarker curves
### Aliases: summary,DualSimulations-method
### Keywords: methods
