...
### Name: summary,PseudoDualSimulations-method
### Title: Summary for Pseudo Dual responses simulations, relative to a
###   given pseudo DLE and efficacy model (except the EffFlexi class model)
### Aliases: summary,PseudoDualSimulations-method
### Keywords: methods
