...
### Name: update,EffFlexi-method
### Title: Update method for the 'EffFlexi' Model class. This is a method
###   to update estimates both for the flexible form model and the random
###   walk model (see details in 'EffFlexi' class object) when new data or
###   new observations of responses are available and added in.
### Aliases: update,EffFlexi-method
### Keywords: methods
