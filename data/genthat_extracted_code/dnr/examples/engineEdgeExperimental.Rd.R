...
### Name: engineEdgeExperimental
### Title: Implementation of simulation engine for dynamic networks without
###   using smoothing estimates of change statistics.
### Aliases: engineEdgeExperimental
...
##D ns <- 10
##D exvar <- NA
##D tmp <- suppressWarnings(
##D   engineEdgeExperimental(start_network=start_network,
##D                          inputcoeff=inputcoeff,ns=ns,
