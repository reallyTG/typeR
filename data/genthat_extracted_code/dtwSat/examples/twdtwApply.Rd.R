...
### Aliases: twdtwApply twdtwApply,twdtwTimeSeries-method
###   twdtwApply-twdtwTimeSeries twdtwApply,twdtwRaster-method
###   twdtwApply-twdtwRaster
...
##D require(parallel)
##D mat_list = mclapply(as.list(ts), mc.cores=2, FUN=twdtwApply, y=patt, weight.fun=log_fun)
##D mat2 = twdtwMatches(alignments=mat_list)
## End(Not run)
## Not run: 
##D   
