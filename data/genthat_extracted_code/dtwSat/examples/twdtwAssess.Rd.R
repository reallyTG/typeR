...
### Aliases: twdtwAssess twdtwAssess,twdtwRaster-method
###   twdtwAssess-twdtwRaster twdtwAssess,data.frame-method
###   twdtwAssess-data.frame twdtwAssess,table-method twdtwAssess-table
###   twdtwAssess,matrix-method twdtwAssess-matrix
###   twdtwAssess,twdtwMatches-method twdtwAssess-twdtwMatches
