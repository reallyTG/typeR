...
### ** Examples
  ...
  ## Not run: 
##D # Minimal use case
##D ArrayToNc(array(1:9, c(3, 3)), 'tmp.nc')
##D 
##D # Works with arrays of any number of dimensions
##D ArrayToNc(array(1:27, c(3, 3, 3)), 'tmp.nc')
##D 
##D # Arrays can also be provided in [named] lists
##D ArrayToNc(list(tos = array(1:27, c(3, 3, 3))), 'tmp.nc')
##D 
...
##D names(dim(lat)) <- 'lat'
##D ArrayToNc(list(tos, lon, lat), 'tmp.nc')
##D   
## End(Not run)
