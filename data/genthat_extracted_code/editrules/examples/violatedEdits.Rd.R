...
### Aliases: violatedEdits violatedEdits.character violatedEdits.editmatrix
###   violatedEdits.editarray violatedEdits.editset plot.violatedEdits
###   summary.violatedEdits as.data.frame.violatedEdits
