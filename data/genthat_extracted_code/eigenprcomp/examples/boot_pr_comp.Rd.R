...
### Name: boot_pr_comp
### Title: Function to compute the confidence intervals for the proportion
###   explained by each eigenvalue, and confidence intervals for each
###   eigenvalue.
### Aliases: boot_pr_comp
### Keywords: PCA Eigenvalues
