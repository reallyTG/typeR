...
### Title: Returns the result of given event study nonparametric tests.
### Aliases: nonparametric_tests
...
##D              "RSA.L", "TOP.CO")
##D nine_eleven_nparam <- get_prices_from_tickers(tickers,
##D                                               start = as.Date("2000-01-01"),
##D                                               end = as.Date("2002-01-01"),
##D                                               quote = "Close",
##D                                               retclass = "zoo") %>%
...
##D     nonparametric_tests(event_start = as.Date("2001-09-11"),
