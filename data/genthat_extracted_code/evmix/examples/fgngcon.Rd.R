...
### Name: fgngcon
### Title: MLE Fitting of Normal Bulk and GPD for Both Tails with Single
###   Continuity Constraint at Both Thresholds Extreme Value Mixture Model
### Aliases: fgngcon lgngcon nlgngcon proflugngcon nlugngcon lgngcon
###   fgngcon nlgngcon proflugngcon nlugngcon nlgngcon fgngcon lgngcon
###   proflugngcon nlugngcon proflugngcon fgngcon lgngcon nlgngcon
###   nlugngcon nlugngcon fgngcon lgngcon nlgngcon proflugngcon
...
##D lines(xx, y)
##D with(fit, lines(xx, dgngcon(xx, nmean, nsd, ul, xil, phiul,
...
##D fitu = fgngcon(x, ulseq = seq(-2, -0.2, length = 10), 
##D  urseq = seq(0.2, 2, length = 10))
##D fitfix = fgngcon(x, ulseq = seq(-2, -0.2, length = 10), 
...
##D    ur, xir, phiur), col="red"))
##D abline(v = c(fit$ul, fit$ur), col = "red")
##D with(fitu, lines(xx, dgngcon(xx, nmean, nsd, ul, xil, phiul,
##D    ur, xir, phiur), col="purple"))
##D abline(v = c(fitu$ul, fitu$ur), col = "purple")
##D with(fitfix, lines(xx, dgngcon(xx, nmean, nsd, ul, xil, phiul,
