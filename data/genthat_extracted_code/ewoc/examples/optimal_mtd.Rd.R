...
### Name: optimal_mtd
### Title: Percent of doses in relation the optimal MTD interval
### Aliases: optimal_mtd
...
##D                        ncores = 2)
##D optimal_mtd(sim$mtd_sim, true_mtd = 20, margin = 0.1*20)
##D optimal_mtd(sim$dose_sim, true_mtd = 20, margin = 0.1*20)
## End(Not run)
