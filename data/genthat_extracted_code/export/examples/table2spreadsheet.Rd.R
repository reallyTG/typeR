...
### Name: table2spreadsheet
### Title: Export statistical output to a table in spreadsheet compatible
###   format (.xlsx or .csv)
### Aliases: table2spreadsheet table2excel table2csv table2csv2 table2excel
###   table2csv table2csv2
