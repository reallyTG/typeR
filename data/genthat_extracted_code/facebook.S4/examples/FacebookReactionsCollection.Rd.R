...
### Name: FacebookReactionsCollection
### Title: Build a collection of Facebook reactions to posts and comments
### Aliases: FacebookReactionsCollection
...
##D  
##D ## Pull all the reactions from each element of the posts collection
##D fb.posts.reactions <- FacebookReactionssCollection(fb.posts, fb_token, n = Inf)
##D  
...
##D  fb.comments.reactions <- FacebookReactionsCollection(id = fb.comments, token = fb_oauth, n = Inf)  
##D    
##D ## Convert the collection to a data frame
##D fb.posts.reactions.df <- as.data.frame(fb.posts.reactions)
##D 
...
##D      FacebookReactionsCollection(n = Inf)
## End(Not run)
