...
### Aliases: fmrs.varsel fmrs.varsel,ANY-method fmrs.varsel-method
### Keywords: AFT Adaptive Algorithm Censored EM ElasticNet FMR LASSO MCP
###   Regression Ridge SCAD SICA Selection
