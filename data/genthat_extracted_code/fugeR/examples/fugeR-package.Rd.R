...
### Name: fugeR-package
### Title: FUzzy GEnetic, a machine learning algorithm to construct
###   prediction model based on fuzzy logic.
### Aliases: fugeR-package
### Keywords: package machine learning fuzzy logic system genetic algorithm
###   model prediction expert decision data mining
