...
### Name: completeTrial.pooledArms
### Title: Treatment Arm-Pooled Simulation-Based Completion of a Randomized
###   Efficacy Trial with a Time-to-Event Endpoint and Fixed Follow-up
###   Using an Interim Data-set
### Aliases: completeTrial.pooledArms
