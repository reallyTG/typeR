...
### Name: bestFitness.Niche
### Title: Returns the fitness of the best chromosome in the niche
### Aliases: bestFitness.Niche Niche.bestFitness bestFitness.Niche
###   bestFitness,Niche-method
