...
### Name: classPredictionMatrix.BigBang
### Title: Predicts class for samples from chromosomes
### Aliases: classPredictionMatrix.BigBang BigBang.classPredictionMatrix
###   classPredictionMatrix.BigBang classPredictionMatrix,BigBang-method
