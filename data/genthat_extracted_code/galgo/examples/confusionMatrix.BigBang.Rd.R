...
### Name: confusionMatrix.BigBang
### Title: Computes the class confusion matrix from a class prediction
###   matrix
### Aliases: confusionMatrix.BigBang BigBang.confusionMatrix
###   confusionMatrix.BigBang confusionMatrix,BigBang-method
###   confusionMatrix
