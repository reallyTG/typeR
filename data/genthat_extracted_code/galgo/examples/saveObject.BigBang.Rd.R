...
### Name: saveObject.BigBang
### Title: Saves the BigBang object into a file in a suitable format
### Aliases: saveObject.BigBang BigBang.saveObject saveObject.BigBang
###   saveObject,BigBang-method saveObject
...
##D    blast(bb, 1)
##D    saveObject(bb, file="bb.Rdata", mode="unObject+compress")
##D    
## End(Not run)
