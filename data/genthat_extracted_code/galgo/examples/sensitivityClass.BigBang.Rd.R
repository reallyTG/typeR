...
### Name: sensitivityClass.BigBang
### Title: Computes the sensitivity of class prediction
### Aliases: sensitivityClass.BigBang BigBang.sensitivityClass
###   sensitivityClass.BigBang sensitivityClass,BigBang-method
###   sensitivityClass
