...
### Name: KINBI
### Title: K-inflated Negative Binomial distributions for fitting a GAMLSS
###   model
### Aliases: KINBI dKINBI pKINBI qKINBI rKINBI
...
data<-data.frame(x=x)
## Not run: 
##D gamlss(x~1, family=inf0NBI, data=data)
##D histDist(x, family=inf0NBI)
## End(Not run)
#--------------------------------------------------------------------------------
...
data<-data.frame(x=x)
## Not run: 
##D gamlss(x~1, family=inf1NBI, data=data)
##D histDist(x, family=inf1NBI)
## End(Not run)
#--------------------------------------------------------------------------------
