...
### Name: KINBII
### Title: K-inflated Negative Binomial type II distributions for fitting a
###   GAMLSS model
### Aliases: KINBII dKINBII pKINBII qKINBII rKINBII
...
data<-data.frame(x=x)
## Not run: 
##D gamlss(x~1, family=inf0NBII, data=data)
##D histDist(x, family=inf0NBII)
## End(Not run)
#--------------------------------------------------------------------------------
...
data<-data.frame(x=x)
## Not run: 
##D gamlss(x~1, family=inf1NBII, data=data)
##D histDist(x, family=inf1NBII)
## End(Not run)
#--------------------------------------------------------------------------------
