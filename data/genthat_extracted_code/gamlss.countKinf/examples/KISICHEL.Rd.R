...
### Aliases: KISICHEL dKISICHEL pKISICHEL qKISICHEL rKISICHEL
...
data<-data.frame(x=x)
## Not run: 
##D gamlss(x~1, family=inf0SICHEL, data=data)
##D histDist(x, family=inf0SICHEL)
## End(Not run)
#--------------------------------------------------------------------------------
...
data<-data.frame(x=x)
## Not run: 
##D gamlss(x~1, family=inf1SICHEL, data=data)
##D histDist(x, family=inf1SICHEL)
## End(Not run)
#--------------------------------------------------------------------------------
