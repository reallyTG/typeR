...
### Name: parcor_ridg
### Title: Compute generalized (ridge-adjusted) partial correlation
###   coefficients from matrix R*. (deprecated)
### Aliases: parcor_ridg
### Keywords: correlations partial
