...
### Name: glacialMelt-method
### Title: Method: Ablation model
### Aliases: glacialMelt-method
###   glacialMelt,RasterStack,RasterStack,RasterStack,RasterStack,RasterStack,RasterStack,RasterStack,RasterStack-method
### Keywords: ~kwd1 ~kwd2
