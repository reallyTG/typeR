...
### Name: interpolateAirP-method
### Title: Method: Air pressure interpolation
### Aliases: interpolateAirP-method
###   interpolateAirP,RasterStack,RasterStack,numeric,RasterLayer-method
### Keywords: ~kwd1 ~kwd2
