...
### Name: group.remmap.cv
### Title: Fit GroupRemMap models for a series of tuning parameters and
###   return the corresponding v-fold cross-validation scores.
### Aliases: group.remmap.cv
### Keywords: methods
