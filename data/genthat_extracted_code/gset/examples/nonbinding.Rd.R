...
### Name: nonbinding
### Title: equivalence and non-binding futility boundaries in group
###   sequential equivalence studies
### Aliases: nonbinding
...
##D   nonbinding(L, U, theta, sigma, n.fix$n1, n.fix$n2, 1:K/K, alpha, beta)             
##D   
##D   # 2. specify plot=FALSE in "binding()" and apply the "figureEF()" command 
##D   bound  <- nonbinding(L, U, theta, sigma, n.fix$n1, n.fix$n2, 1:K/K, alpha, beta, plot=FALSE)  
##D   figureEF(bound, K)
##D 
##D   # obtain nminmax
##D   bound  <- nminmax(L, U, theta, sigma, n.fix$n1, n.fix$n2, 1:K/K, alpha, beta, binding=FALSE)
##D   bound
##D   figureEF(bound, K)
##D   
## End(Not run)
