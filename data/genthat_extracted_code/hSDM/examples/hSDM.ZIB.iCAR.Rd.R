...
### Name: hSDM.ZIB.iCAR
### Title: ZIB (Zero-Inflated Binomial) model with CAR process
### Aliases: hSDM.ZIB.iCAR
...
##D 
##D #== Data-set
##D Data <- data.frame(Y,trials,cells,X1,X2)
##D ## Uncomment if you want covariates on the observability process 
##D ## Data <- data.frame(Y,trials,cells,X1,X2,W1,W2)
...
##D 
##D mod.hSDM.ZIB.iCAR <- hSDM.ZIB.iCAR(presences=Data$Y,
...
##D summary(mod.hSDM.ZIB.iCAR$mcmc)
##D 
##D #= MCMC and posteriors
##D pdf(file="Posteriors_hSDM.ZIB.iCAR.pdf")
##D plot(mod.hSDM.ZIB.iCAR$mcmc)
##D dev.off()
##D 
##D pdf(file="Posteriors.rho_hSDM.ZIB.iCAR.pdf")
##D plot(mod.hSDM.ZIB.iCAR$rho.pred)
##D dev.off()
##D 
##D #= Summary plots
##D 
...
##D r.rho[] <- rho
##D rho.pred <- apply(mod.hSDM.ZIB.iCAR$rho.pred,2,mean)
##D r.rho.pred[] <- rho.pred
##D r.visited[] <- 0
##D r.visited[visited.cells] <- 1
##D # prob.p
##D r.prob.p <- Landscape
##D r.prob.p[] <- mod.hSDM.ZIB.iCAR$prob.p.pred
##D 
##D pdf(file="Summary_hSDM.ZIB.iCAR.pdf")
##D par(mfrow=c(3,2))
