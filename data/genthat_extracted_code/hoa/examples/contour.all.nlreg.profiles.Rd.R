...
### Name: contour.all.nlreg.profiles
### Title: Contour Method for 'nlreg' Objects
### Aliases: contour.all.nlreg.profiles
### Keywords: methods nonlinear
