...
### Name: plot.nlreg.profiles
### Title: Use plot() on a 'profile.nlreg' and 'all.profiles.nlreg' object
### Aliases: plot.nlreg.profile plot.all.nlreg.profiles
### Keywords: methods regression hplot
...
##D plot( metsulfuron.prof, lwd2 = 2, nframe = c(2,3) )
## End(Not run)
