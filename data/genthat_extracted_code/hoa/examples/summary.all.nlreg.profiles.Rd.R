...
### Name: summary.all.nlreg.profiles
### Title: Summary Method for Objects of Class 'all.nlreg.profiles'
### Aliases: summary.all.nlreg.profiles
...
##D summary( metsulfuron.prof, alpha = c(0.1, 0.05) )
## End(Not run)
