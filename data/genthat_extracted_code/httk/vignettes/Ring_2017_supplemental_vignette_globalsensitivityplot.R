...
## ----change_factor_levels, eval=FALSE------------------------------------
#  
...
## ----define_sens_colormap, eval=FALSE------------------------------------
#  ylgnbu <- RColorBrewer::brewer.pal(n=9, name="YlGnBu")

## ----global_sens_plots, eval=FALSE---------------------------------------
#  for (ecg in c('Total',
#                    'Age.6.11',
#                    'Age.12.19',
#                    'Age.20.65',
