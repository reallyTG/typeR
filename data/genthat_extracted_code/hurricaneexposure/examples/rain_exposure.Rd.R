...
### Name: rain_exposure
### Title: Write storm rain exposure files
### Aliases: rain_exposure
...
##D 
##D # By county
##D rain_exposure(locations = c("22071", "51700"),
##D               start_year = 1995, end_year = 2005,
##D               rain_limit = 100, dist_limit = 100,
...
##D                           "36085", "36081", "36119",
##D                           "22071", "51700"))
##D rain_exposure(locations = communities,
##D               start_year = 1995, end_year = 2005,
##D               rain_limit = 100, dist_limit = 100,
##D               out_dir = "~/tmp/storms")
##D }
