if (require("testthat") && require("insight") && require("nnet") && require("MASS")) {
  ...
  test_that("find_predictors", {
    ...
    expect_identical(find_predictors(m1, flatten = TRUE), c("age", "lwt", "race", "smoke"))
  ...
  test_that("get_data", {
    ...
    expect_equal(colnames(get_data(m1)), c("low", "age", "lwt", "race", "smoke"))
  })
  ...
  test_that("find_terms", {
    expect_equal(find_terms(m1), list(response = "low", conditional = c("age", "lwt", "race", "smoke")))
    expect_equal(find_terms(m1, flatten = TRUE), c("low", "age", "lwt", "race", "smoke"))
  })
