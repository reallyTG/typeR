...
### Name: TV
### Title: Conservative exact confidence intervals for treatment effects on
###   a binary outcome in a two-stage randomized experiment with
###   interference
### Aliases: TV
### Keywords: interference exact confidence interval
