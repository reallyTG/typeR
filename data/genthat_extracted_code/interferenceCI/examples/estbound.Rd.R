...
### Name: estbound
### Title: Estimates and bounds for treatment effects on a binary outcome
###   in a two-stage randomized experiment with interference
### Aliases: estbound
### Keywords: interference estimate bounds
