...
### Name: print.jointmeta1SE
### Title: Print function for 'jointmeta1SE' objects
### Aliases: print.jointmeta1SE
...
##D 
##D         #print the results of the bootstrap function
##D         print(onestagefitSE)
##D     
## End(Not run)
