...
### Name: locus.likes.peaks
### Title: likeLTD::locus.likes.peaks
### Aliases: locus.likes.peaks
...
##D       converge=FALSE)
##D 
##D # get locus likelihoods under prosecution
##D locus.likes.peaks(hypP,results$Pros)
##D 
##D # get locus LRs
##D locus.likes.peaks(hypP,results$Pros)/locus.likes.peaks(hypD,results$Def)
## End(Not run)
