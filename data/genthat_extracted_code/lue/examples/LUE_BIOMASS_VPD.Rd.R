...
### Name: LUE_BIOMASS_VPD
### Title: Light Use Efficiency Model to Estimate Biomass with Vapour
###   Pressure Deficit
### Aliases: LUE_BIOMASS_VPD
### Keywords: datasets
...
##D data(tmax)
##D data(tdew)
##D LUE_BIOMASS_VPD(fpar,par1,tmin,tmax,tdew,-2,12,1.5,4,3)
## End(Not run)
library(raster)
