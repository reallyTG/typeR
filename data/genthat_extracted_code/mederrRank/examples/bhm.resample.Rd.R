...
### Name: bhm.resample
### Title: Resampling Transformation for the Markov Chain Monte Carlo
###   Estimation Simulation of the Bayesian Hierarchical Model for
###   Identifying the Most Harmful Medication Errors
### Aliases: bhm.resample
