...
### Name: mgVarPart
### Title: Variation partitioning of the genetic distance matrix
### Aliases: mgVarPart
...
##D 
##D ## Use the selected MEM eigenvectors and coordinates in
##D ## variation partitioning
##D radialVarPart <- mgVarPart(radialDM, allSelected, radialXY)
## End(Not run)
