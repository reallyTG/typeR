...
### Name: smd_lgor
### Title: Covariance between standardized mean difference and log odds
###   ratio
### Aliases: smd_lgor
...
## simple example
smd_lgor(r=0.71,n1c=34,n2c=35,n1t=25,n2t=32,
...
SBP_DD=unlist(lapply(1:nrow(Geeganage2010),function(i){smd_lgor(r=0.71,
