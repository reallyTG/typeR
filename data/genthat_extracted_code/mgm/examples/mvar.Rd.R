...
### Name: mvar
### Title: Estimating mixed Vector Autoregressive Model (mVAR)
### Aliases: mvar var.mgm
...
##D 
##D 
##D ## We generate data from a mixed VAR model and then recover the model using mvar()
##D 
...
##D mvar_obj$wadj[5, 6, 2] # cross-lagged effect of 6 on 2 over lag lags[2]
...
##D 
##D # How to get the exact parameter estimates?
##D # Example: the full parameters for the crossed-lagged interaction of 2 on 1 over lag lags[1]
##D mvar_obj$rawlags[[1]][[1]][[2]] 
##D 
##D # 4) Predict / Compute nodewise Error
##D pred_mvar <- predict.mgm(mvar_obj, dlist$data)
##D 
##D head(pred_mvar$predicted) # first 6 rows of predicted values
##D pred_mvar$errors # Nodewise errors
##D 
