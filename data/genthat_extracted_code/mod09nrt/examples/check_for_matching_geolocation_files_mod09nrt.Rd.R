...
### Name: check_for_matching_geolocation_files_mod09nrt
### Title: Checks that every MODIS surface reflectance project HDF has a
###   matching MOD03 file
### Aliases: check_for_matching_geolocation_files_mod09nrt
...
##D check_for_matching_geolocation_files_mod09nrt(moddir=moddir, modtxt="MOD09", geoloctxt="MOD03", 
