...
### Name: mu_synch
### Title: Determination of Motor Unit Synchronization by Various Methods
###   of Cross Correlation Histogram Examination
### Aliases: mu_synch
### Keywords: Zscore, cumulative motor recurrence, sigmax, sum
###   synchronization, unit, visual,
