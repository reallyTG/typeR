...
### Name: recurrence_intervals
### Title: Calculate Recurrence Intervals Between Motor Units or Neuron
###   Discharge Trains
### Aliases: recurrence_intervals
### Keywords: action discharge motor potentials, recurrence, trains unit,
