...
### Name: visual_mu_synch
### Title: Determination of Motor Unit Synchronization by Visual Inspection
###   of Cross Correlation Histogram
### Aliases: visual_mu_synch
### Keywords: motor recurrence, synchronization, unit, visual
