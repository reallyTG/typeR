...
###################################################
### code chunk number 1: german.Rnw:36-38
###################################################
...
###################################################
### code chunk number 2: german.Rnw:43-47
###################################################
library("mpath")
library("zic")
library("pscl")
...
###################################################
### code chunk number 5: german.Rnw:60-65 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 6: german.Rnw:68-72 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 7: german.Rnw:75-76 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 8: german.Rnw:79-82 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 9: german.Rnw:85-86 (eval = FALSE)
###################################################
## se(fit.lasso, minBic, log=FALSE)


###################################################
### code chunk number 10: german.Rnw:89-92 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 11: german.Rnw:95-103 (eval = FALSE)
###################################################
## n <- dim(dat)[1]
## K <- 10
## set.seed(197)
...
###################################################
### code chunk number 12: german.Rnw:108-110 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 13: german.Rnw:113-116 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 14: german.Rnw:119-120 (eval = FALSE)
###################################################
## se(fit.mcp, minBic, log=FALSE)


###################################################
### code chunk number 15: german.Rnw:123-126 (eval = FALSE)
###################################################
## AIC(fit.mcp)[minBic]
## BIC(fit.mcp)[minBic]
...
###################################################
### code chunk number 16: german.Rnw:129-133 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 17: german.Rnw:137-139 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 18: german.Rnw:142-145 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 19: german.Rnw:148-149 (eval = FALSE)
###################################################
## se(fit.scad, minBic, log=FALSE)


###################################################
### code chunk number 20: german.Rnw:152-155 (eval = FALSE)
###################################################
## AIC(fit.scad)[minBic]
## BIC(fit.scad)[minBic]
...
###################################################
### code chunk number 21: german.Rnw:158-162 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 22: german.Rnw:165-166 (eval = FALSE)
###################################################
## print(proc.time()-ptm)
