...
##D radialNetwork(List = Flare, fontSize = 10, opacity = 0.9)
##D 
##D #### Create a tree dendrogram from an R hclust object
##D hc <- hclust(dist(USArrests), "ave")
##D radialNetwork(as.radialNetwork(hc))
##D radialNetwork(as.radialNetwork(hc), fontFamily = "cursive")
##D 
...
##D ))
##D 
##D radialNetwork(List = CanadaPC, fontSize = 10)
## End(Not run)
