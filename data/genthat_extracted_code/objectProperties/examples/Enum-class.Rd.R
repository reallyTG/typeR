...
### Aliases: setSingleEnum SingleEnum-class MultipleEnum-class
###   setMultipleEnum setSingleEnum Enum-class Color-class Color
###   ColorEnum-class setColorEnum GlyphEnum-class setGlyphEnum
