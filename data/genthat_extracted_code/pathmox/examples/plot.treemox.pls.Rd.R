...
##D 
##D  # re-ordering those segmentation variables with ordinal scale (Age and Education)
...
##D 
##D  # applying function treemox.pls
##D  mob_nodes <- treemox.pls(mob_pls, mob_pathmox)
##D 
##D  # default plot
##D  # comparative barplots of endogenous latent variables between nodes
##D  plot(mob_nodes, comp.by="nodes")
##D 
##D  # comparative barplots of nodes between latent regressors
##D  plot(mob_nodes, comp.by="latents", decreasing=TRUE)
##D  
## End(Not run)
