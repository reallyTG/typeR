...
##D 
##D  # apply plspm
##D  mob_pls = plspm(data_mobile, mob_path, mob_blocks,
##D                  modes = mob_modes, scheme="factor", scaled=FALSE)
##D 
...
##D 
##D  # get PLS-PM of nodes 2 and 3
##D  node2 = plspmox(mob_pls, mob_pathmox, node=2)
##D  node3 = plspmox(mob_pls, mob_pathmox, node=3)
##D  
## End(Not run)
