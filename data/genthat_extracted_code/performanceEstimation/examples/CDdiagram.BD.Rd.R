...
### Name: CDdiagram.BD
### Title: CD diagrams for the post-hoc Boferroni-Dunn test
### Aliases: CDdiagram.BD
### Keywords: models
...
##D 
##D ## obtaining a CD diagram comparing all workflows against
##D ## the baseline (defined in the previous call to pairedComparisons)
