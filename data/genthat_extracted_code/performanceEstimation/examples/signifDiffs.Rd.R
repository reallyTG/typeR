...
### Name: signifDiffs
### Title: Obtains a list with the set of paired differences that are
###   statistically significant according to a p-value threshold
### Aliases: signifDiffs
### Keywords: models
...
##D 
##D ## Obtaining the subset of differences that are significant
##D ## with 99% confidence 
##D sds <- signifDiffs(res,p.limit=0.01)
##D 
## End(Not run)
