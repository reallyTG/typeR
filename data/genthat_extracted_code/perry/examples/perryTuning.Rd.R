...
### Name: perryTuning
### Title: Resampling-based prediction error for tuning parameter selection
### Aliases: coef.perryTuning fitted.perryTuning perryTuning
###   perryTuning.call perryTuning.function predict.perryTuning
