...
##D 
##D parpre <- par(mar=c(4, 4, 2, 5)+0.4)
##D par(xpd=TRUE)
##D plot(YS, main="Use of different beaches along the time", 
##D control.legend=list(x=2000, y=0.4, legend=c("Yalimapo", "Galibi", "Irakumpapy")))
##D par(mar=parpre)
##D 
##D # Example to modify order of series
##D plot(cst, order=c("Galibi.Suriname", "Irakumpapy.French.Guiana"))
##D plot(cst, order=c("Galibi.Suriname", "Irakumpapy.French.Guiana", "Yalimapo.French.Guiana"))
## End(Not run)
