...
### Name: getParameterAtSites.Sequence
### Title: Get the values of a site-process specific paramater for a
###   process and a collection of Site objects aggregated by a Sequence
###   object
### Aliases: getParameterAtSites.Sequence Sequence.getParameterAtSites
###   getParameterAtSites,Sequence-method
