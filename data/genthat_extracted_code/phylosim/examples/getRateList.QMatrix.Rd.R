...
### Name: getRateList.QMatrix
### Title: Get a list of events and their unscaled rates from a QMatrix
###   object
### Aliases: getRateList.QMatrix QMatrix.getRateList
###   getRateList,QMatrix-method
