...
### Name: setProposeBy.GeneralInDel
### Title: Set the function used for proposing indel lengths
### Aliases: setProposeBy.GeneralInDel GeneralInDel.setProposeBy
###   setProposeBy,GeneralInDel-method setProposeBy.GeneralInsertor
