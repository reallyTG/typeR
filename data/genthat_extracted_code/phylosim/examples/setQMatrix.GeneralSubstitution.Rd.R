...
### Name: setQMatrix.GeneralSubstitution
### Title: Set the QMatrix object aggregated by a GeneralSubstitution
###   object
### Aliases: setQMatrix.GeneralSubstitution GeneralSubstitution.setQMatrix
###   setQMatrix,GeneralSubstitution-method
