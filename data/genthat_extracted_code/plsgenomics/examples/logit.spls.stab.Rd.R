...
### Name: logit.spls.stab
### Title: Stability selection procedure to estimate probabilities of
###   selection of covariates for the LOGIT-SPLS method
...
##D n <- 100
##D p <- 100
##D sample1 <- sample.bin(n=n, p=p, kstar=10, lstar=2, 
...
##D stab1 <- logit.spls.stab(X=X, Y=Y, lambda.ridge.range=lambda.ridge.range, 
