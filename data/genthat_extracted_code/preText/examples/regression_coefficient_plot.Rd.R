...
### Name: regression_coefficient_plot
### Title: Regression Coefficient Plot
### Aliases: regression_coefficient_plot
...
##D     verbose = TRUE)
##D # generate regression results
##D regression_coefficient_plot(preText_results,
##D                             remove_intercept = TRUE)
## End(Not run)
