...
### Name: wordfish_rank_plot
### Title: Plot of Wordfish rankings of documents
### Aliases: wordfish_rank_plot

### ** Examples

## Not run: 
##D # replicates Wordfish analysis from Denny and Spirling (2016)
##D # load the package
##D library(preText)
##D # load in the data
...
##D deviations <- wordfish_rank_plot(wordfish_results,
##D                   labels = preprocessed_documents$labels,
##D                   invert = FALSE,
##D                   ranking = c("Lab1983","Lab1987","Lab1992","Lab1997",
##D                               "Con1997","Con1992","Con1987","Con1983"),
##D                   black_white = FALSE,
##D                   one_matrix = FALSE,
##D                   return_deviations = FALSE)
## End(Not run)
