...
### Name: run_swath2grid_mod02nrt
### Title: Run MRTSwath swath2grid tool
### Aliases: run_swath2grid_mod02nrt
...
##D fns_df = check_for_matching_geolocation_files(moddir, modtxt="MOD02", geoloctxt="MOD03")
##D fns_df
##D 
...
##D 	{
##D 
##D prmfn = write_MRTSwath_param_file_mod02nrt(prmfn="tmpMRTparams.prm", tifsdir=tifsdir,
##D  modfn=fns_df$mod02_fns[i], geoloc_fn=fns_df$mod03_fns[i], ul_lon=ul_lon, ul_lat=ul_lat,
##D   lr_lon=lr_lon, lr_lat=lr_lat)
##D print(scan(file=prmfn, what="character", sep="\n"))
##D 
##D run_swath2grid_mod02nrt(mrtpath="swath2grid", prmfn="tmpMRTparams.prm", tifsdir=tifsdir,
##D  modfn=fns_df$mod302_fns[i], geoloc_fn=fns_df$mod03_fns[i], ul_lon=ul_lon, ul_lat=ul_lat,
##D   lr_lon=lr_lon, lr_lat=lr_lat)
##D 
##D 	}
##D 
