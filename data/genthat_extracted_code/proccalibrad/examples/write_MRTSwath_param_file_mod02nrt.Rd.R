...
### Name: write_MRTSwath_param_file_mod02nrt
### Title: Write a parameter control file for MRTSwath
### Aliases: write_MRTSwath_param_file_mod02nrt
...
##D fns_df = check_for_matching_geolocation_files_mod02nrt(moddir, modtxt="MOD02", geoloctxt="MOD03")
##D fns_df
##D 
