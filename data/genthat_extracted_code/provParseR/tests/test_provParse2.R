...
expect_equal (tool.df$tool.name, "RDataTracker")
expect_equal (tool.df$tool.version, "3.0.1")
...
expect_equal(nrow(proc.proc.df), 46)
...
expect_equal(nrow(data.proc.df), 37)
...
expect_equal(nrow(proc.data.df), 34)
...
expect_equal (nrow (variables.set), 29)
