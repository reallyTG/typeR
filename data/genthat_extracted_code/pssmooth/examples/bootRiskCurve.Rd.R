...
### Name: bootRiskCurve
### Title: Bootstrap Estimation of Conditional Clinical Endpoint Risk under
###   Placebo and Treatment Given Biomarker Response to Treatment in a
###   Baseline Surrogate Measure Three-Phase Sampling Design
### Aliases: bootRiskCurve
