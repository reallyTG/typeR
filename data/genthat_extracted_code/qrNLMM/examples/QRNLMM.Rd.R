...
### Aliases: QRNLMM
### Keywords: SAEM quantile quantile regression nonlinear mixed models ALD

### ** Examples

## Not run: 
##D #Using the Soybean data
##D 
##D data(Soybean)
##D attach(Soybean)
##D 
...
##D 
##D exprNL = expression((fixed[1]+random[1])/
...
##D for(i in 1:48)
##D {
##D   lines(seqc,nlmodel(x = seqc,fixed = fxd,random = weights[i,]),lty=2)
##D }
##D 
...
##D 
##D ---------------------------------------------------
##D Quantile Regression for Nonlinear Mixed Model
##D ---------------------------------------------------
##D Quantile = 0.5
##D Subjects = 48 ; Observations = 412
##D 
##D - Nonlinear function
##D 
##D function(x,fixed,random,covar=NA){
##D   resp = (fixed[1] + random[1])/(1 + exp(((fixed[2] +
##D           random[2]) - x)/(fixed[3] + random[3])))
##D   return(resp)}
##D 
##D -----------
##D Estimates
...
##D beta 1 18.80029    0.53098  35.40704        0
##D beta 2 54.47930    0.29571 184.23015        0
##D beta 3  8.25797    0.09198  89.78489        0
##D 
##D sigma = 0.31569
##D 
##D Random effects Variance-Covariance Matrix matrix
##D          b1       b2      b3
##D b1 24.36687 12.27297 3.24721
##D b2 12.27297 15.15890 3.09129
##D b3  3.24721  3.09129 0.67193
##D 
##D ------------------------
##D Model selection criteria
##D ------------------------
##D         Loglik      AIC      BIC       HQ
##D Value -622.899 1265.798 1306.008 1281.703
##D 
##D -------
##D Details
##D -------
...
##D MC sample = 20
##D Cut point = 0.25
##D Processing time = 22.83885 mins
## End(Not run)
