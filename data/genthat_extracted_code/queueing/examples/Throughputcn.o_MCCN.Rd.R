...
### Name: Throughputcn.o_MCCN
### Title: Returns a matrix with the Throughput from each class and every
###   population of a Multi Class Closed Network
### Aliases: Throughputcn.o_MCCN
