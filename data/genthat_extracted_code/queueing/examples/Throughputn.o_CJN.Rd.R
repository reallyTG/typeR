...
### Name: Throughputn.o_CJN
### Title: Returns a vector with the each Throughput from 1 to the
###   parameter n (population passed as input) of a Closed Jackson Network
### Aliases: Throughputn.o_CJN
