...
### Aliases: summary_table cbind.qwraps2_summary_table
###   rbind.qwraps2_summary_table qsummary
...
## Not run: 
##D   cbind(tab1, tab4) # error because rows are not the same
##D   rbind(tab1, tab2) # error because columns are not the same
## End(Not run)
