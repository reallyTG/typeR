...
### Name: ReadGrib
### Title: Extract data from grib files
### Aliases: ReadGrib
### Keywords: file
...
##D 
##D #Get the data
##D model.info <- GribGrab(urls.out[1], my.pred, levels, variables)
##D 
##D #Extract the data
##D model.data <- ReadGrib(model.info[[1]]$file.name, levels, variables)
##D 
##D #Reformat it
