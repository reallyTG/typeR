...
### Name: classifyRasclass
### Title: Classsifier function for rasclass objects
### Aliases: classifyRasclass classifyRasclass,rasclass-method
### Keywords: raster classification landcover
