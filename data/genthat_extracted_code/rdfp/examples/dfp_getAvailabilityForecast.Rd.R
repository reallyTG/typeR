...
### Name: dfp_getAvailabilityForecast
### Title: ForecastService
### Aliases: dfp_getAvailabilityForecast
...
##D request_data <- list(lineItem=hypothetical_line_item,
##D                      forecastOptions=list(includeTargetingCriteriaBreakdown='true', 
##D                                           includeContendingLineItems='true'))
##D dfp_getAvailabilityForecast_result <- dfp_getAvailabilityForecast(request_data)
## End(Not run)
