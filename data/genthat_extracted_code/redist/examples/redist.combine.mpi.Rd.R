...
### Name: redist.combine.mpi
### Title: Combine successive runs of 'redist.mcmc.mpi'
### Aliases: redist.combine.mpi
...
##D out <- redist.combine.mpi(savename = "test", nsims = 10000, nloop = 2,
##D nthin = 10, nunits = length(algdat.pfull$adjlist), tempadj = tempAdjMat)
## End(Not run)
