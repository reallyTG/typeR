...
### Title: Prediction for Function-on Scalar Regression with variable
###   selection
### Aliases: predict.fosr.vs
...
##D data$Y = Yi.obs
##D fit.mcp = fosr.vs(Y~., data = data[1:80,], method="grMCP")
##D predicted.value = predict(fit.mcp, data[81:100,])
##D 
## End(Not run)
