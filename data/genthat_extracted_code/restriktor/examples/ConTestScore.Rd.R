...
### Name: conTestScore
### Title: Score-bar test for iht
### Aliases: conTestScore conTestScore.conLM conTestScore.conRLM
###   conTestScore.conGLM
...
##D   myNeq1 <- 0
##D   
##D   conTest(fit1.lm, constraints = Amat1, test = "score",
...
##D           type = "A", test = "score", boot = "parametric", R = 9)
## End(Not run)            
