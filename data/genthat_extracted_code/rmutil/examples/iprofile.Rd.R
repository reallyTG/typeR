...
### Name: iprofile
### Title: Produce Individual Time Profiles for Plotting
### Aliases: iprofile iprofile.default plot.iprofile
### Keywords: hplot

### ** Examples

## Not run: 
##D ## try this after you have repeated package installed
##D library(repeated)
##D times <- rep(1:20,2)
