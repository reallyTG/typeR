...
### Name: NgetFinalResultsNonBlocking
### Title: XML-RPC method getFinalResultsNonBlocking of Neos
### Aliases: NgetFinalResultsNonBlocking
### Keywords: IO
...
##D id = 0)
##D NgetFinalResultsNonBlocking(obj = test, convert = TRUE)
## End(Not run)
