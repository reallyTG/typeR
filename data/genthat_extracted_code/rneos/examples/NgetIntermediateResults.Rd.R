...
### Name: NgetIntermediateResults
### Title: XML-RPC method getIntermediateResults of Neos
### Aliases: NgetIntermediateResults
### Keywords: IO
...
##D id = 0)
##D NgetIntermediateResults(obj = test, convert = TRUE)
## End(Not run)
