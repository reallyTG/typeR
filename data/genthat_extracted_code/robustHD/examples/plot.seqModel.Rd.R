...
### Name: plot.seqModel
### Title: Plot a sequence of regression models
### Aliases: plot.grplars plot.perrySeqModel plot.perrySparseLTS plot.rlars
###   plot.seqModel plot.sparseLTS plot.tslars plot.tslarsP
### Keywords: hplot
