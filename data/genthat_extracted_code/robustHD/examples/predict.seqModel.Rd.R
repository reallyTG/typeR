...
### Name: predict.seqModel
### Title: Predict from a sequence of regression models
### Aliases: predict.grplars predict.rlars predict.seqModel
###   predict.sparseLTS predict.tslars predict.tslarsP
### Keywords: regression
