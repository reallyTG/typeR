...
### Name: robustgam.GIC
### Title: Smoothing parameter selection by GIC (grid search)
### Aliases: robustgam.GIC
...
##D 
##D # robust GAM fit
##D robustfit.gic <- robustgam.GIC(x, y, family=true.family, p=3, c=1.6, show.msg=FALSE,
##D   count.lim=400, smooth.basis='tp'); robustfit <- robustfit.gic$optim.fit
##D 
##D # ordinary GAM fit
