...
### Name: robustgam.GIC.optim
### Title: Smoothing parameter selection by GIC (by optim)
### Aliases: robustgam.GIC.optim
...
##D 
##D # robust GAM fit
##D robustfit.gic <- robustgam.GIC.optim(x, y, family=true.family, p=3, c=1.6, show.msg=FALSE,
##D   count.lim=400, smooth.basis='tp', lsp.initial=log(1e-2) ,lsp.min=-15, lsp.max=10,
##D   gic.constant=log(n), method="L-BFGS-B"); robustfit <- robustfit.gic$optim.fit
##D 
##D 
##D # ordinary GAM fit
