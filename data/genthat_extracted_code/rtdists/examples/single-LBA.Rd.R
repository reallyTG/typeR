...
### Aliases: single-LBA dlba_norm plba_norm rlba_norm dlba_gamma plba_gamma
###   rlba_gamma dlba_frechet plba_frechet rlba_frechet dlba_lnorm
###   plba_lnorm rlba_lnorm
