...
### Name: BCs4vd
### Title: Robust biclustering by sparse singular value decomposition
###   incorporating stability selection
### Aliases: BCs4vd s4vd BCs4vd-class \S4method{biclust}{matrix,BCs4vd}
### Keywords: biclustering svd stability selection
