...
### Name: VE.Jk.B.RegCoI.Hajek
### Title: The Berger (2007) unequal probability jackknife variance
###   estimator for the estimator of the intercept regression coefficient
###   using the Hajek point estimator
### Aliases: VE.Jk.B.RegCoI.Hajek
