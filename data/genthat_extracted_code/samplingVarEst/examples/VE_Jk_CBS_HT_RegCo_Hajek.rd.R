...
### Name: VE.Jk.CBS.HT.RegCo.Hajek
### Title: The Campbell-Berger-Skinner unequal probability jackknife
###   variance estimator for the estimator of the regression coefficient
###   using the Hajek point estimator (Horvitz-Thompson form)
### Aliases: VE.Jk.CBS.HT.RegCo.Hajek
