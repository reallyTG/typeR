...
### Name: VE.Jk.CBS.SYG.RegCoI.Hajek
### Title: The Campbell-Berger-Skinner unequal probability jackknife
###   variance estimator for the estimator of the intercept regression
###   coefficient using the Hajek point estimator (Sen-Yates-Grundy form)
### Aliases: VE.Jk.CBS.SYG.RegCoI.Hajek
