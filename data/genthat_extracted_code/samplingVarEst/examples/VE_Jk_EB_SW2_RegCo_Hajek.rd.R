...
### Name: VE.Jk.EB.SW2.RegCo.Hajek
### Title: The self-weighted two-stage sampling Escobar-Berger (2013)
###   jackknife variance estimator for the estimator of the regression
###   coefficient using the Hajek point estimator
### Aliases: VE.Jk.EB.SW2.RegCo.Hajek
