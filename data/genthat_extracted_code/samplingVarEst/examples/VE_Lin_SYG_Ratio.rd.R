...
### Name: VE.Lin.SYG.Ratio
### Title: The unequal probability linearisation variance estimator for the
###   estimator of a ratio (Sen-Yates-Grundy form)
### Aliases: VE.Lin.SYG.Ratio
