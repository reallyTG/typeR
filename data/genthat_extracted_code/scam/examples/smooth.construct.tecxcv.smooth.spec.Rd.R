...
### Name: smooth.construct.tecxcv.smooth.spec
### Title: Tensor product smoothing constructor for bivariate function
###   subject to mixed constraints: convexity constraint wrt the first
###   covariate and concavity wrt the second one
### Aliases: smooth.construct.tecxcv.smooth.spec
### Keywords: models regression

### ** Examples

 ## Not run: 
##D ## tensor product `tecxcv' example 
##D   ## simulating data...
##D    set.seed(1)
##D    n <- 30
...
##D ## fit model ...
##D    b <- scam(y~s(x1,x2,k=c(10,10),bs="tecxcv"), data=dat)
##D ## plot results ...
