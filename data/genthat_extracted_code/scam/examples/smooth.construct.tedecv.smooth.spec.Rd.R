...
### Name: smooth.construct.tedecv.smooth.spec
...
### Aliases: smooth.construct.tedecv.smooth.spec
### Keywords: models regression

### ** Examples

 ## Not run: 
##D ## tensor product `tedecv' example 
##D   ## simulating data...
##D 
##D    set.seed(2)
##D    n <- 30
...
##D ## fit model ...
##D    b <- scam(y~s(x1,x2,k=c(10,10),bs="tedecv",m=2), data=dat)
##D ## plot results ...
