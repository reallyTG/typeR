...
### Name: smooth.construct.tedmi.smooth.spec
### Title: Tensor product smoothing constructor for bivariate function
###   subject to double monotone increasing constraint
### Aliases: smooth.construct.tedmi.smooth.spec
### Keywords: models regression

### ** Examples

 ## Not run: 
##D ## tensor product `tedmi' example 
##D   ## simulating data...
##D    set.seed(1)
##D    n <- 30
...
##D ## fit model ...
##D    b <- scam(y~s(x1,x2,k=c(10,10),bs="tedmi",m=2),family=gaussian, data=dat)
##D ## plot results ...
