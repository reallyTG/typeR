...
### Name: smooth.construct.temicx.smooth.spec
...
### Aliases: smooth.construct.temicx.smooth.spec
### Keywords: models regression

### ** Examples

 ## Not run: 
##D ## tensor product `temicx' example 
##D   ## simulating data...
##D 
##D    set.seed(1)
##D    n <- 30
...
##D ## fit model ...
##D    b <- scam(y~s(x1,x2,k=c(10,10),bs="temicx",m=2), data=dat)
##D ## plot results ...
