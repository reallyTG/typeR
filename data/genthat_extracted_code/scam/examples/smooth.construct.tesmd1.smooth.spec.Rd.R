...
### Name: smooth.construct.tesmd1.smooth.spec
### Title: Tensor product smoothing constructor for a bivariate function
###   monotone decreasing in the first covariate
### Aliases: smooth.construct.tesmd1.smooth.spec
### Keywords: models regression

### ** Examples

 ## Not run: 
##D ## tensor product `tesmd1' example 
##D   ## simulating data...
##D    set.seed(2)
##D    n <- 30
...
##D ## fit model ...
##D    b <- scam(y~s(x1,x2,k=c(10,10),bs="tesmd1",m=2),data=dat,sp=NULL)
##D ## plot results ...
