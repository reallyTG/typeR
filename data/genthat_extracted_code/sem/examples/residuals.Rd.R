...
### Aliases: residuals.sem residuals.msem standardizedResiduals
###   standardizedResiduals.sem standardizedResiduals.msem
###   normalizedResiduals normalizedResiduals.objectiveML
###   normalizedResiduals.objectiveGLS normalizedResiduals.msemObjectiveML
### Keywords: models
...
##D residuals(sem.dhp)
##D normalizedResiduals(sem.dhp) 
##D standardizedResiduals(sem.dhp) # same as residuals because model is fit to correlations
##D     
## End(Not run)
