...
### Name: print.sim.seqtest.cor
### Title: Print sim.seqtest
### Aliases: print.sim.seqtest.cor
...
##D 
##D sim.obj <- sim.seqtest.cor(rho.sim = 0.3, k = seq(4, 16, by = 1), rho = 0.3,
##D                            alternative = "greater",
##D                            delta = 0.25, alpha = 0.05, beta = 0.05,
##D                            runs = 10000, output = FALSE)
##D 
##D print(sim.obj)
##D 
...
##D 
##D sim.obj <- sim.seqtest.cor(rho.sim = 0.55, k = 16, rho = 0.3,
##D                            alternative = "greater",
