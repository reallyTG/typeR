...
### Name: sghmccvSetup
### Title: Create an sghmccv object
### Aliases: sghmccvSetup
...
##D optStepsize = 1e-1
##D sghmccv = sghmccvSetup(logLik, dataset, params, stepsize, optStepsize)
##D nIters = 10^4L
##D # Initialize location estimate
##D locEstimate = 0
##D # Initialise TensorFlow session
##D sess = initSess(sghmccv)
##D for ( i in 1:nIters ) {
##D     sgmcmcStep(sghmccv, sess)
##D     locEstimate = locEstimate + 1 / nIters * getParams(sghmccv, sess)$theta
##D }
