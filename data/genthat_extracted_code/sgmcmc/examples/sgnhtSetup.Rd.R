...
##D sgnht = sgnhtSetup(logLik, dataset, params, stepsize)
##D nIters = 10^4L
##D # Initialize location estimate
##D locEstimate = 0
##D # Initialise TensorFlow session
##D sess = initSess(sgnht)
##D for ( i in 1:nIters ) {
##D     sgmcmcStep(sgnht, sess)
##D     locEstimate = locEstimate + 1 / nIters * getParams(sgnht, sess)$theta
##D }
