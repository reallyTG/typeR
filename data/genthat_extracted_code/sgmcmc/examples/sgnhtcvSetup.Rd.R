...
### Name: sgnhtcvSetup
### Title: Create an sgnhtcv object
### Aliases: sgnhtcvSetup
...
##D optStepsize = 1e-1
##D sgnhtcv = sgnhtcvSetup(logLik, dataset, params, stepsize, optStepsize)
##D nIters = 10^4L
##D # Initialize location estimate
##D locEstimate = 0
##D # Initialise TensorFlow session
##D sess = initSess(sgnhtcv)
##D for ( i in 1:nIters ) {
##D     sgmcmcStep(sgnhtcv, sess)
##D     locEstimate = locEstimate + 1 / nIters * getParams(sgnhtcv, sess)$theta
##D }
