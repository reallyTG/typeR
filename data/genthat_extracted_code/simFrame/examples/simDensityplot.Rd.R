...
### Aliases: simDensityplot simDensityplot-methods
###   simDensityplot,SimResults-method simdensityplot SimDensityplot
###   Simdensityplot simdensityplot-methods SimDensityplot-methods
