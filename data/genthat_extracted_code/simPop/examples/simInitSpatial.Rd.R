...
### Name: simInitSpatial
### Title: Generation of smaller regions given an existing spatial variable
###   and a table.
### Aliases: simInitSpatial
### Keywords: manip
...
## Not run: 
##D # use only HH counts
##D simPopObj1 <- simInitSpatial(simPopObj, additional="district", region="db040", tspatialHH=tabHH,
##D tspatialP=NULL)
##D 
##D # use only P counts
##D simPopObj2 <- simInitSpatial(simPopObj, additional="district", region="db040", tspatialHH=NULL,
##D tspatialP=tabP)
##D 
##D # use P and HH counts
##D simPopObj3 <- simInitSpatial(simPopObj, additional="district", region="db040", tspatialHH=tabHH,
##D tspatialP=tabP)
## End(Not run)
