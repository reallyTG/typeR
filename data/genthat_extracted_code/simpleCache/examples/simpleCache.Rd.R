...
### Name: simpleCache
### Title: Provides intuitive functions for caching R objects, encouraging
###   faster reproducible and restartable R analysis
### Aliases: simpleCache simpleCache-package simpleCache
