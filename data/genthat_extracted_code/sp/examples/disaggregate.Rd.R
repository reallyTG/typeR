...
### Name: disaggregate-methods
### Title: disaggregate SpatialLines, SpatialLinesDataFrame,
###   SpatialPolygons, or SpatialPolygonsDataFrame objects
### Aliases: disaggregate disaggregate-methods
###   disaggregate,SpatialPolygons-method
###   disaggregate,SpatialPolygonsDataFrame-method
###   disaggregate,SpatialLines-method
###   disaggregate,SpatialLinesDataFrame-method
### Keywords: methods
