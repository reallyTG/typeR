...
### Name: computeResponseSummary
### Title: Given interim data, compute the response end-point summary
### Aliases: computeResponseSummary
### Keywords: design
...
##D   dInterim <- generateInterimData(d, trialParameters$interimLookTime[2],
##D                                       trialParameters$adminCensoringTime)
##D   computeResponseSummary(dInterim)
## End(Not run)
