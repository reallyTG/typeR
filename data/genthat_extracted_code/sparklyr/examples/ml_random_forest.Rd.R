...
### Name: ml_random_forest_classifier
### Title: Spark ML - Random Forest
### Aliases: ml_random_forest_classifier ml_random_forest
...
##D 
##D rf_model <- iris_training %>%
##D   ml_random_forest(Species ~ ., type = "classification")
##D 
##D pred <- ml_predict(rf_model, iris_test)
##D 
