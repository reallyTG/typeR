...
### Name: rotate_pages
### Title: Rotate selected pages of a pdf file
### Aliases: rotate_pages

### ** Examples

## Not run: 
##D # This command promts the user to select the file interactively.
##D # Rotate page 2 and 6 to 90 degrees clockwise
##D rotate_pages(rotatepages = c(3,6), page_rotation = 90)
## End(Not run)
...
##D output_path <-  file.path(dir, paste("Rotated_pgs_pdf.pdf",  sep = ""))
##D rotate_pages(rotatepages = c(2,3), page_rotation = 90,  input_path, output_path)
## End(Not run)
