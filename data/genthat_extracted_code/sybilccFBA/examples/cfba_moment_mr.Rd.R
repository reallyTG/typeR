...
### Name: cfba_moment_mr
### Title: Function: cfba_moment_mr: implement MOMENT method taking into
###   account multifunctional enzymes
### Aliases: cfba_moment_mr
### Keywords: FBA MOMENT cost constraint FBA
...
##D 
##D   sol=cfba_moment_mr(model,mod2,kcat,MW=mw,verbose=3,RHS=0.27,solver="glpkAPI",medval=3600*22.6) 
##D 
## End(Not run)
