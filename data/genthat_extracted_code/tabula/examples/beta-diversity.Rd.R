...
### Aliases: beta-diversity turnover turnover-method similarity
###   similarity-method turnover,CountMatrix-method
###   turnover,IncidenceMatrix-method similarity,CountMatrix-method
###   similarity,IncidenceMatrix-method
