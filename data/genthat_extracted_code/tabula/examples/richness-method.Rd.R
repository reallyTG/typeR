...
### Name: richness
### Title: Richness and rarefaction
### Aliases: richness richness-method rarefaction rarefaction-method
###   rarefaction,CountMatrix-method richness,CountMatrix-method
###   richness,IncidenceMatrix-method
