...
### Name: arrow_feather_dataset
### Title: Creates a 'ArrowFeatherDataset'.
### Aliases: arrow_feather_dataset

### ** Examples

## Not run: 
##D dataset <- arrow_feather_dataset(
##D     list('/path/to/a.feather', '/path/to/b.feather'),
