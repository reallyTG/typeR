...
### Name: boot_autocov
### Title: A function that computes the bootstrapped autocovariances for a
###   time series object. The computations are done via phase scrambling
###   bootstrap
### Aliases: boot_autocov
### Keywords: bootstrap time series ACF
