...
###################################################
### code chunk number 2: article.Rnw:112-114
###################################################
...
###################################################
### code chunk number 3: article.Rnw:122-135
###################################################
...
###################################################
### code chunk number 4: article.Rnw:173-174
###################################################
library("trajectories")


###################################################
### code chunk number 5: article.Rnw:179-192
###################################################
set.seed(10)
library("spacetime")
library("sp")
...
###################################################
### code chunk number 6: article.Rnw:196-197
###################################################
plot(A1)


###################################################
### code chunk number 7: article.Rnw:207-213
###################################################
x <- runif(10,0,1)
y <- runif(10,0,1)
...
###################################################
### code chunk number 8: article.Rnw:219-229
###################################################
x = c(7,6,6,7,7)
y = c(6,5,4,4,3)
n = length(x)
...
###################################################
### code chunk number 9: article.Rnw:235-255
###################################################
# person B, track 1:
x = c(2,2,1,1,2,3)
y = c(5,4,3,2,2,3)
...
###################################################
### code chunk number 10: article.Rnw:304-308
###################################################
dim(A1)
dim(B1)
stbox(A1)
...
###################################################
### code chunk number 11: article.Rnw:312-313
###################################################
stplot(Tr, attr = "co2", arrows = TRUE, lwd = 3, by = "IDs",cex.axis=2)


###################################################
### code chunk number 12: article.Rnw:323-329
###################################################
set.seed(10)
x <- rTrack();x
...
###################################################
### code chunk number 13: article.Rnw:333-336
###################################################
...
###################################################
### code chunk number 14: article.Rnw:350-353
###################################################
library("forecast")
data("A3")
auto.arima.Track(A3)
...
###################################################
### code chunk number 15: article.Rnw:386-390
###################################################
...
###################################################
### code chunk number 16: article.Rnw:408-416
###################################################
 # par(mfrow=c(1,2))
...
###################################################
### code chunk number 17: article.Rnw:459-461
###################################################
...
###################################################
### code chunk number 18: article.Rnw:479-487
###################################################
...
###################################################
### code chunk number 20: article.Rnw:586-608
###################################################
...
###################################################
### code chunk number 21: article.Rnw:666-672
###################################################
