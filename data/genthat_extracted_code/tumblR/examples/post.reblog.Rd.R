...
##D base_hostname <- "blogname.tumblr.com"		
##D id <- 97468713814
##D 					
##D post.reblog(base_hostname = base_hostname, type = "text", tags = "tumblr, api", 
##D title_text = "Title", body = "foo 2", id = id, reblog_key="2FOPxeOa",
##D token = token, consumer_key = consumer_key, consumer_secret = consumer_secret)
## End(Not run)					
