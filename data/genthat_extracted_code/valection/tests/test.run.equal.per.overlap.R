...
if (valection::check.for.library()) {
	...
	expectedResult <- read.table("expected.run.equal.per.overlap.txt");

	test_that("Equal per overlap sampling works", {
