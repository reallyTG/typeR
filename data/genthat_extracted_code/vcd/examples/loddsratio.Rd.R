...
### Name: loddsratio
### Title: Calculate Generalized Log Odds Ratios for Frequency Tables
### Aliases: loddsratio oddsratio loddsratio.default loddsratio.formula
###   coef.loddsratio confint.loddsratio dim.loddsratio dimnames.loddsratio
###   print.loddsratio vcov.loddsratio as.matrix.loddsratio
###   as.array.loddsratio aperm.loddsratio t.loddsratio
