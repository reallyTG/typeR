...
### Name: plot-methods
### Title: ~~ Methods for Function 'plot' in Package 'x12' ~~
### Aliases: plot-methods plot,x12Output-method plot,x12Single-method
###   plot,x12Batch-method plot
...
##D plot(s,showAllout=TRUE,span=c(1951,1,1953,12),points_original=TRUE,cex_out=2)
##D #with showOut
...
##D plot(s,showOut="TC1954.Mar",span=c(1954,1,1955,12))
