...
### Name: plotRsdAcf
### Title: ~~ Methods for Function 'plotRsdAcf' in Package 'x12' ~~
### Aliases: plotRsdAcf plotRsdAcf-methods plotRsdAcf,x12Output-method
###   plotRsdAcf,x12Single-method
...
##D plot(s,forecast=TRUE,points_fc=TRUE,col_fc="purple",lty_fc=2,lty_original=3,lwd_fc=0.9,
##D   lwd_ci=2)
