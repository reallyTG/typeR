...
### Name: cb.gblinear.history
### Title: Callback closure for collecting the model coefficients history
###   of a gblinear booster during its training.
### Aliases: cb.gblinear.history
