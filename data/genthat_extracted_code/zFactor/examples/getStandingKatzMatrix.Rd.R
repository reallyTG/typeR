...
### Name: getStandingKatzMatrix
### Title: Generate a matrix of Standing-Katz pseudo-reduced pressure and
###   tenperature by giving vector values
### Aliases: getStandingKatzMatrix
