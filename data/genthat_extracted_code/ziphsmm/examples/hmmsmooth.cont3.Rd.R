...
### Name: hmmsmooth.cont3
### Title: Compute the posterior state probabilities for continuous-time
###   hidden Markov models with covariates in the state-dependent
###   parameters and transition rates
### Aliases: hmmsmooth.cont3
...
##D 
##D fit2 <-  fasthmmfit.cont3(y=y,x=designx,M=2,
##D   initparm=workparm, timeindex=timeindex,
##D   hessian=FALSE, method="CG", control=list(trace=1))
##D post <- hmmsmooth.cont3(y,designx,2,fit2$prior,fit2$tpm,fit2$zeroparm,
##D        fit2$emitparm,timeindex)
## End(Not run)
