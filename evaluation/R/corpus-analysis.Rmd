...
summary_corpus <- function(df, prefix) {
  ...
  overview_table(
    ...
    r(paste(prefix, "mean expr coverage"), percent(mean(w_coverage))),
    r(paste(prefix, "median expr coverage"), percent(median(w_coverage))),
    ...
    r(paste(prefix, "mean revdes"), mean(w_revdeps)),
    r(paste(prefix, "median revdes"), median(w_revdeps)),
