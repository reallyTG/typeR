...
total_recorded_sigs <- readRDS("../data/final_recorded_sigs_by_package.RDS")
...
plot_records <- ggplot(data=records_by_fun, aes(x=invo_obs, y=invo_rec)) +
                geom_point(size=0.25) + 
                labs( title = "Numbers of Observed Signatures",
                      y = "Recorded Invocations in Pkg (Thousands)",
                      x = "Observed Invocations in Pkg (Thousands)") +
