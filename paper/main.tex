...
polymorphism. Instead, it supports union and any types. A union type is
...
unused. Furthermore, list element types can be inferred as any if they have
more than 5 different types. Values with many different types can result in
