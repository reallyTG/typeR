...
types.
 ...
 Here, the first case can be explained by a lack of testing (or generally incorrect use in a client), and the second case is explained by programmers not fully understanding R's language semantics (\AT{as who would expect as.integer(NULL) to yield integer(0)?}).
