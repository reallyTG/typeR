...
%Here, we've made a number of small discoveries.
%We see environments, which are essentially dignified lists (i.e., they are lists with a parent list, and are used to implement scoping).
%\AT{Possibly explain some of these? Dunno.}
