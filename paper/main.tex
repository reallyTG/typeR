...
\midrule
\dbl & 13,255 & 11.06 & 41,560,797 & 1.59\\
\lgl & 10,142 & 8.46 & 712,895,959 & 27.21\\
\null & 9,175 & 7.66 & 122,202,183 & 4.66\\
\chr & 9,171 & 7.65 & 794,058,588 & 30.31\\
\VEC\dbl & 7,811 & 6.52 & 29,272,232 & 1.12\\
\addlinespace
\VARGS & 7,759 & 6.48 & 76,369,333 & 2.92\\
\any & 6,243 & 5.21 & 255,539,497 & 9.75\\
\VEC\chr & 4,576 & 3.82 & 88,233,523 & 3.37\\
...
\caption{Top types of arguments in R.}
\end{table}
...
Figure shows the distribution of functions against the number of polymorphic
positions. We observe that \PercMonomorphicFunctions
...
polymorphic parameter or return type. Polymorphic functions are spread
across many packages, \CountMonomorphicPackages out of the 412 packages from our
corpus export only monomorphic functions.
...
\typetracer observed that \PROPSTRUCTSDYN of lists had a \code{names} attribute, and in R, ``fields'' of named lists can be accessed using the
\code{$} operator.
