...
Figure~\ref{fig:L1argcounts} shows the polymorphicity of argument positions
 ...
 found in Figure~\ref{fig:L1funcounts}.

% latex table generated in R 3.5.1 by xtable 1.8-3 package
% Fri Mar 29 18:10:23 2019
\begin{table}[ht]\label{fig:L1argcounts}\centering\begin{tabular}{lrr}  \hline
...
Figure~\ref{fig:L1funcounts} that a sizeable number of functions are
polymorphic.  Functions are said to be polymorphic if at least one of their
arguments or return are polymorphic.  \AT{Say more?}
