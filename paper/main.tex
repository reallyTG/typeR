...
For one, the page limit is way less.
...
Some low hanging fruit include a call-site analysis, and developing a metric to judge whether we trust a suggested annotation. 
This might involve a rerun, for the call site stuff.
We should think of anything else we want in the rerun before I spend the cycles to do it.

Broadly, I think we should focus on the study and what we learned from it.
There are some fluffy sections (like 8.2) that can probably be removed.

We probably want something to generate code from the type annotations we have. 
I'm working on a prototype. 

Better justify the experiment.
Why is looking at tests, examples, vignettes ok?
