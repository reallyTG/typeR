...
of contracts. This section presents each step of this pipeline (\emph{cf.}
Figure~\ref{fig:pipeline}). The pipeline is run in parallel using GNU
...
The following overviews the main simplification rules as well as the simple
notion of subtyping that we have adopted here.
...
\begin{figure}[!h]\centering\includegraphics[width=.9\linewidth]
