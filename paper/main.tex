...
In this section, we aim to comment globally on the things we learned during our analysis, and propose a type system which is reasonable given its coverage of existing code.
...
\AT{Working through this now.}

Now we wonder: {\it what kinds of function-level annotations are useful?}
