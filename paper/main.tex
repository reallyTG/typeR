...
\newcommand{\attr}[2]{\ensuremath{#1\,({\mathit #2})}\xspace}
...
mentioned in \AT{an earlier section}, the class of values can be easily
...
\item if the analysis encounters \code{ typeof(x) == "double"}, it will look
  ...
  generating the annotation {\tt \dbls} or {\tt \dblv} accordingly.  This is
