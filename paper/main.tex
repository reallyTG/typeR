...
<<Insert proportion of monorphic types in argument and in function
signature. Perhaps a table of monomorphic type signatures that are
popular...>>
...
We observe that XXX of the positions have a single type ascribed to them,
and, only XXX have four or more types ascribed to them. Parameter PARAMNAME
of function XXXXCOLONCOLONXXX has the maximum, XXX, types ascribed to it.
