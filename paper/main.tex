...
\begin{figure}[!hb]{\small\begin{lstlisting}[style=R]
> cat_and_list <- function(x, y) as.list(c(x, y)) # c(2, c(3, 1)) => c(2, 3, 1)
> cat_and_list(2, c(3, 1)) # => list(2, 3, 1)
\end{lstlisting}}
...
\AT{TODO: side by side in minipage?}
...
\begin{tabular}{rlrr}
 ...
 & Argument Polymorphism & Count & Percentage \\ 
  \hline
1 & Full Monomorphic & 448K & 85.50 \\ 
  2 & Monomorphic in Type & 471K & 90.28 \\ 
...
\begin{tabular}{rlrr}
 ...
 & Function Polymorphism & Count & Percentage \\ 
  \hline
1 & Full Monomorphic & 82K & 66.27 \\ 
  2 & Monomorphic in Type & 94K & 75.74 \\ 
...
We see that roughly 10\% of all argument positions in R are polymorphic in type.
...
As for functions, roughly 25\% are polymorphic in type, or put differently 25\% have at least one polymorphic argument or a polymorphic return.
