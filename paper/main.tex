...
Indeed, our notion of subtyping on classes is rather weak, and one extension would be to include class hierarchies in the subtyping of classes;
...
\begin{tabular}{lrrr}
  ...
  Formula & 17 & 82 & ?? \\ 
   \hline
\end{tabular}
\caption{5 most polymorphic packages.}
\end{table}

Now, what makes these so polymorphic?
\AT{maybe first score functions, penalizing big ones, and then consolidate?}
