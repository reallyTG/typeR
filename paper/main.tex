...
is.point.inside <- function (point, polyg) {
    ...
    ...
\end{lstlisting}}\caption{Example of \l or \D (list or vector of doubles) argument (from {\tt bivrp} package).}\label{fig:listvec}\end{figure}
...
calculates point estimates for some object. The caller specifies {\tt fn}, which is either a function {\it or} the name of a function which will be evaluated on the object samples to estimate parameters.
