...
Table~\ref{tbl:corpus-type-breakdown} reports on the 10 most frequent types
...
\begin{tabular}{lrrrr}
\toprule
Type & Args & \% of Args & Observations & \% of Observations\\
\midrule
...
Figure~\ref{fig:unionfreq} shows the number of types inferred at each position of a
...
Figure~\ref{fig:singlefreq} provides a breakdown of the different type categories
...
Figure~\ref{fig:funpoly} shows the distribution of functions against the number of
