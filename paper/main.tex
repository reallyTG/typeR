...
oshka metaprograms in the same style as Tidyverse, scatterD3 metaprograms on plot objects, and yaml converts R expressions to YAML expressions.
...
%
%. nohup parallel -j55 -a promise_reduce_me.txt Rscript mar_new_processing_files/promise_processed_reduced_to_new_form.R &
%
%
%
%
