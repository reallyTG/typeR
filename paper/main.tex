...
\begin{tabular}{lrr}
 ...
 Argument Signature & Count & Percentage \\ 
  ...
  \D, \I & 3256 & 1.2\% \\ 
   \hline
\end{tabular}
\caption{Most frequent argument signatures in L0.}
\end{table}
...
Recall that in L0, data frames will appear as lists.
...
Figure~\ref{fig:chardbl} lays out an example of this polymorphic signature, showing that lists and vectors can be accessed by strings as well as by numerics.
...
Unfortunately, the truth is that dates in R are not standardized.
