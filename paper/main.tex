...
\newcommand{\INDEXCOINCIDENCE}{3,426\xspace}
\newcommand{\TOTALINDEXY}{6,461\xspace}
...
\AT{Do we want to talk about how sometimes we can't eval an argument, even if a function executes successfully?
Like pipe from magrittr.}
...
\subsection{Most Polymorphic Functions}
...
The first annotation option is 
