...
\AT{Collection of examples of polymorphism...}
...
\end{lstlisting}}\caption{Example of data.frame/vector/double argument (from {\tt klausR} package).}\label{fig:charclos}\end{figure}
