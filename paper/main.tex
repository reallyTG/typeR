...
The first row of the table reads: 13255 arguments have type \dbl, represnting 11.06\% of argument type signatures, and \typetracer observed 41M values of type \dbl flowing into or out of functions while running on the core package corpus, which represents only 1.59\% of dynamically observed values.
...
\begin{tabular}{lrrrr}
\toprule
Type & Args with Type & \% Args & Dynamic Observations & \% Dynamic Types\\
\midrule
