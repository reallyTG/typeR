...
(Section~\ref{sec:R}).  To circumvent this obstacle, we instead
...
\item First, we wanted to ensure that \typetracer captured type for
  ...
  relies on argument promises being forced.  There are a few reasons for this.
...
\caption{Struct example from the \code{agricolae} package.}
\label{fig:struct-ex}
\end{center}
\end{figure}
