...
There are some clear limitations to the L0 type system.
...
We refer to this as the L1 type system.  An example of a signature in this type system can be found in Figure~\ref{fig:exL1}.
...
In Table~\ref{tab:toppolyL1}, we see the prominence of {\tt double} and {\tt integer} polymorphism.
...
In many programming languages, NULLs inhabit every type, and this is not the case in our L1.
L1 reflects many of R's implementation details, and this distinction is no exception:
