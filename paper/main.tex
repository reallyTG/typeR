...
\code{dplyr::group_indices}: \FUN{\CLASS{data.frame}, \VARGS}{\VEC\int}

\code{lava::index}: \FUN{\CLASS{lvm} \; | \; \CLASS{lvmfit}, \VARGS}{\; ? \; \LIST{any}}

\code{diptest::dip}: \FUN{\VEC\dbl, \chr \; | \; \lgl, \lgl, \dbl}{\CLASS{dip} \; | \; \dbl} 

\code{stabledist::cospi2}: \FUN{\VEC\dbl}{\VEC\dbl}

\code{matrixcalc::matrix.power}: \FUN{\CLASS{matrix}, \dbl}{\CLASS{matrix}}
