...
Assuming that type sequences can be reordered freely, redundant types can be
deleted, types that are subsumed by subtyping can be removed, and nullable
types can be introduced to replace \null.
