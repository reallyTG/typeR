...
To evaluate the effectiveness of our type annotation language and contract checking framework, we conducted a large-scale experiment based on the packages we used to inform our language design.
The core corpus of 412 packages represents some of the most widely used and thoroughly tested R libraries on CRAN.
To conduct the evaluation in this section, we configured \typetracer to infer the types of each of the functions that are visible to package clients.
\typetracer inferred these types based on the package text, example, and vignette code.
This section is divided in two parts:
First, we present general information about the generated types, and about the core analysis corpus, and next we discuss an evaluation of the inferred types against the reverse-dependencies (read: clients) of the corpus we analyzed.
...
\AT{Let's talk about some of the data related to our types themselves.
How many types?
How big are they?
How many are mono? Poly?
Stuff like that.}
