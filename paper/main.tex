...
Designing a type system for R is no small feat, as statically make sense of R code is complicated by a language design which fosters an interactive programming style by minimizing programmer overhead.
