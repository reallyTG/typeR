...
code but are referenced by other packages \AT{I should collect stats on this}.
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[scale=0.6]{linesofrandccode.pdf}
\caption{Lines of Code (R and C) in the Analyzed Corpus}
\label{allcloc}
\end{center}
\end{figure}
