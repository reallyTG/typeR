...
type `dplyr::group\_indices` <class<`data.frame`>, ...> => integer[];
...
type `openssl::decrypt\_envelope` <raw[], raw[], raw[], class<`key`, `rsa`>, any> => raw[];

dbplyr:type `set\_win\_current\_group` <null | character[]> => (character[] | null);
