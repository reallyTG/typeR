...
isn't. For this reason our
analysis focuses on packages; these bundle reusable units of R code with
documentation, sample data and use-cases.
...
\begin{tabular}{rlrr}
 ...
 & Argument Polymorphism & Count & Percentage \\ 
  \hline
  1 & Full Monomorphic & 784K & 85.19 \\ 
  2 & Monomorphic in Type & 839K & 91.27 \\ 
  3 & Monomorphic in Class & 831K & 90.31 \\ 
  4 & Monomorphic in Attribute Pattern & 830K & 90.25 \\ 
  5 & Total Seen & 920K & --- \\ 
     \hline
\end{tabular}
...
\begin{tabular}{rlrr}
 ...
 & Function Polymorphism & Count & Percentage \\ 
  \hline
  1 & Full Monomorphic & 143K & 65.64 \\ 
  2 & Monomorphic in Type & 169K & 77.65 \\ 
  3 & Monomorphic in Class & 163K & 75.13 \\ 
  4 & Monomorphic in Attribute Pattern & 161K & 74.31 \\ 
  5 & Total Seen & 217K & --- \\ 
   \hline
\end{tabular}
...
\begin{tabular}{lrr}
 ...
 Polymorphic Type Signature & \# Occurrences & \% of Total Polymorphism \\ 
  \hline
vector/double, vector/integer & 10,316 & 12.85 \\ 
scalar/double, scalar/integer & 7,194 & 8.96 \\ 
NULL, vector/double & 3,087 & 3.85 \\ 
data.frame, vector/double & 2,604 & 3.24 \\ 
NULL, scalar/character & 2,333 & 2.91 \\ 
list$<$any$>$, list$<$double$>$ & 2,224 & 2.77 \\ 
NULL, scalar/double & 2,066 & 2.57 \\ 
raw\_NA, vector/double & 1,465 & 1.83 \\ 
list$<$any$>$, list$<$list$>$ & 1,426 & 1.78 \\ 
NULL, vector/character & 1,385 & 1.73 \\ 
     \hline
\end{tabular}
...
\AT{Generate tables. The stuff we do is: real, NULL fold, NA fold.}
