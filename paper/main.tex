...
Table~\ref{fig:singlefreq} provides a breakdown of the different type
categories observed at uni-typed positions. Scalar, class and vector are the
most common type categories. The shaded rows correspond to polymorphic
types. Removing those gives us \CountMonomorphicPositions
(\PercMonomorphicPositions) monomorphic positions in a corpus of
\CountPositions parameter and return positions.
