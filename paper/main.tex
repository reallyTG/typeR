...
\AT{TODO simple running example}
...
These functions really {\it should} be outliers, as they are really operating over any type.
They feature so prominently here since many of the values which flowed into them had some amount of attribute or class information.
...
In fact, all but knitLatex implement some form of metaprogramming:
the oshka package metaprograms in the same style as Tidyverse, the scatterD3 package metaprograms on plot objects, and the yaml package converts R expressions to YAML expressions.
This is a trend we have observed: {\it the most polymorphic functions in R are metaprogramming their arguments}.
...
%
%  ls trace_export_promises > promise_packages_FINAL.txt
%
%
%
%
...
Another note regarding function signatures is the {\tt ...} function argument.
...
Our analysis ignores these extra arguments, instead flagging functions which have them.
If building an annotation for such a function, the ... argument is always ascribed the \l type.
...
When working on a general purpose language such as JavaScript, we as programmers can appeal to our own intuitions, as many of us have had at least some interaction with the language.
...
DSLs are gaining in popularity as more and more domain-experts, who may not have a traditional programming background, are exposed to the practice of programming, and the needs of these experts differ from our own.
...
\AT{Need a somewhat stronger conclusion.}
